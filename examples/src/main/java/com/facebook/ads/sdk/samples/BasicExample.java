    ...
    public static void main(String[] args) {
        try {
            ...
            Campaign campaign = account.createCampaign()
                    .setName("Java SDK Test Campaign2")
            ...
            System.out.println(Campaign.fetchById(campaign.getFieldId(), ExampleConfig.CONTEXT));
            System.out.println(AdSet.fetchById(adset.getFieldId(), ExampleConfig.CONTEXT));
