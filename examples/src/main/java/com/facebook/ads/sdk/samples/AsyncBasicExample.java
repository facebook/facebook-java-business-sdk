...
public class AsyncBasicExample {
    ...
    public static void main(String[] args) {
        try {
            final Targeting targeting = new Targeting().setFieldGeoLocations(
                    new TargetingGeoLocation().setFieldCountries(Arrays.asList("US"))
            );
            final AdAccount account = new AdAccount(ExampleConfig.ACCOUNT_ID, ExampleConfig.CONTEXT);
            ...
            try {
                ListenableFuture<Campaign> c = Campaign.fetchByIdAsync(campaign.getFieldId(), ExampleConfig.CONTEXT);
                ...
                ListenableFuture<AdSet> a = AdSet.fetchByIdAsync(adset.getFieldId(), ExampleConfig.CONTEXT);
