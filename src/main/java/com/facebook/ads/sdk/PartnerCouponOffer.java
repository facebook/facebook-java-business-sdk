 ...
 *
 */
public class PartnerCouponOffer extends APINode {
  ...
  public PartnerCouponOffer fetch() throws APIException{
    PartnerCouponOffer newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<PartnerCouponOffer> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<PartnerCouponOffer>)(
      new APIRequest<PartnerCouponOffer>(context, "", "/", "GET", PartnerCouponOffer.getParser())
  ...
  public static ListenableFuture<APINodeList<PartnerCouponOffer>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", PartnerCouponOffer.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static PartnerCouponOffer loadJSON(String json, APIContext context, String header) {
    PartnerCouponOffer partnerCouponOffer = getGson().fromJson(json, PartnerCouponOffer.class);
    if (context.isDebug()) {
  ...
  public static APINodeList<PartnerCouponOffer> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          partnerCouponOffers.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            partnerCouponOffers.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  partnerCouponOffers.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              partnerCouponOffers.add(loadJSON(obj.toString(), context, header));
            }
          }
          return partnerCouponOffers;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              partnerCouponOffers.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          partnerCouponOffers.add(loadJSON(json, context, header));
          return partnerCouponOffers;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<PartnerCouponOffer> {
    ...
    public PartnerCouponOffer parseResponse(String response, String header) throws APIException {
      return PartnerCouponOffer.parseResponse(response, getContext(), this, header).head();
    }
    ...
    public ListenableFuture<PartnerCouponOffer> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<ResponseWrapper, PartnerCouponOffer>() {
           public PartnerCouponOffer apply(ResponseWrapper result) {
             try {
  ...
  public static APIRequest.ResponseParser<PartnerCouponOffer> getParser() {
    return new APIRequest.ResponseParser<PartnerCouponOffer>() {
      public APINodeList<PartnerCouponOffer> parseResponse(String response, APIContext context, APIRequest<PartnerCouponOffer> request, String header) throws MalformedResponseException {
