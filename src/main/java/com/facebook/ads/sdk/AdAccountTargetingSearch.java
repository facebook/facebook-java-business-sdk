...
public class AdAccountTargetingSearch extends APINode {
  @SerializedName("id")
  ...
  public AdAccountTargetingSearch() {
  }

  public String getId() {
    return getFieldId().toString();
  }
  public static AdAccountTargetingSearch loadJSON(String json, APIContext context) {
    AdAccountTargetingSearch adAccountTargetingSearch = getGson().fromJson(json, AdAccountTargetingSearch.class);
    if (context.isDebug()) {
      JsonParser parser = new JsonParser();
      JsonElement o1 = parser.parse(json);
      JsonElement o2 = parser.parse(adAccountTargetingSearch.toString());
    ...
    adAccountTargetingSearch.mContext = context;
    adAccountTargetingSearch.rawValue = json;
    return adAccountTargetingSearch;
  }

  public static APINodeList<AdAccountTargetingSearch> parseResponse(String json, APIContext context, APIRequest request) {
    APINodeList<AdAccountTargetingSearch> adAccountTargetingSearchs = new APINodeList<AdAccountTargetingSearch>(request, json);
    JsonArray arr;
    JsonObject obj;
    JsonParser parser = new JsonParser();
    try{
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          try {
            ...
            adAccountTargetingSearchs.setPaging(paging.get("before").getAsString(), paging.get("after").getAsString());
  ...
  public AdAccountTargetingSearch setFieldId(String value) {
    this.mId = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch setFieldName(String value) {
    this.mName = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch setFieldType(EnumType value) {
    this.mType = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch setFieldPath(List<String> value) {
    this.mPath = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch setFieldDescription(String value) {
  ...
  public AdAccountTargetingSearch setFieldSource(String value) {
    this.mSource = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch setFieldPartner(String value) {
    this.mPartner = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch setFieldAudienceSize(Long value) {
  ...
  public AdAccountTargetingSearch setFieldCountry(String value) {
    this.mCountry = value;
    return this;
  }
  ...
  public AdAccountTargetingSearch copyFrom(AdAccountTargetingSearch instance) {
  ...
  public static APIRequest.ResponseParser<AdAccountTargetingSearch> getParser() {
    return new APIRequest.ResponseParser<AdAccountTargetingSearch>() {
      public APINodeList<AdAccountTargetingSearch> parseResponse(String response, APIContext context, APIRequest<AdAccountTargetingSearch> request) {
        return AdAccountTargetingSearch.parseResponse(response, context, request);
      }
    };
  }
}