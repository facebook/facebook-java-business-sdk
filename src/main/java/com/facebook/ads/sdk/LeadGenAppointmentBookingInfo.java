...
public class LeadGenAppointmentBookingInfo extends APINode {
  @SerializedName("advertiser_timezone_offset")
  ...
  public LeadGenAppointmentBookingInfo fetch() throws APIException{
    LeadGenAppointmentBookingInfo newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<LeadGenAppointmentBookingInfo> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<LeadGenAppointmentBookingInfo>)(
      new APIRequest<LeadGenAppointmentBookingInfo>(context, "", "/", "GET", LeadGenAppointmentBookingInfo.getParser())
  ...
  public static ListenableFuture<APINodeList<LeadGenAppointmentBookingInfo>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", LeadGenAppointmentBookingInfo.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            leadGenAppointmentBookingInfos.setPaging(previous, next);
  ...
  public String getFieldAdvertiserTimezoneOffset() {
    return mAdvertiserTimezoneOffset;
  }

  public List<String> getFieldAppointmentDurations() {
    return mAppointmentDurations;
  }
  ...
  public static class APIRequestGet extends APIRequest<LeadGenAppointmentBookingInfo> {
    ...
    public LeadGenAppointmentBookingInfo parseResponse(String response) throws APIException {
      return LeadGenAppointmentBookingInfo.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<LeadGenAppointmentBookingInfo> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<String, LeadGenAppointmentBookingInfo>() {
