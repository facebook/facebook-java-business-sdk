...
public class P2MInvoicePayments extends APINode {
  ...
  public static APIRequest.ResponseParser<P2MInvoicePayments> getParser() {
    return new APIRequest.ResponseParser<P2MInvoicePayments>() {
      public APINodeList<P2MInvoicePayments> parseResponse(String response, APIContext context, APIRequest<P2MInvoicePayments> request, String header) throws MalformedResponseException {
        return P2MInvoicePayments.parseResponse(response, context, request, header);
      }
    };
  }
}
