 ...
 *
 */
public class BusinessPixelTOS extends APINode {
  ...
  public BusinessPixelTOS fetch() throws APIException{
    BusinessPixelTOS newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<BusinessPixelTOS> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<BusinessPixelTOS>)(
      new APIRequest<BusinessPixelTOS>(context, "", "/", "GET", BusinessPixelTOS.getParser())
  ...
  public static ListenableFuture<APINodeList<BusinessPixelTOS>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", BusinessPixelTOS.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static BusinessPixelTOS loadJSON(String json, APIContext context, String header) {
    BusinessPixelTOS businessPixelTOS = getGson().fromJson(json, BusinessPixelTOS.class);
    if (context.isDebug()) {
  ...
  public static APINodeList<BusinessPixelTOS> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          businessPixelTOSs.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            businessPixelTOSs.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  businessPixelTOSs.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              businessPixelTOSs.add(loadJSON(obj.toString(), context, header));
            }
          }
          return businessPixelTOSs;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              businessPixelTOSs.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          businessPixelTOSs.add(loadJSON(json, context, header));
          return businessPixelTOSs;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<BusinessPixelTOS> {
  ...
  public static APIRequest.ResponseParser<BusinessPixelTOS> getParser() {
    return new APIRequest.ResponseParser<BusinessPixelTOS>() {
      public APINodeList<BusinessPixelTOS> parseResponse(String response, APIContext context, APIRequest<BusinessPixelTOS> request, String header) throws MalformedResponseException {
