...
public class AdAccountAdRulesHistory extends APINode {
  ...
  public static enum EnumAction {
      ...
      @SerializedName("CONSOLIDATE_ASC_FRAGMENTATION")
      VALUE_CONSOLIDATE_ASC_FRAGMENTATION("CONSOLIDATE_ASC_FRAGMENTATION"),
      @SerializedName("CONSOLIDATE_FRAGMENTATION")
      VALUE_CONSOLIDATE_FRAGMENTATION("CONSOLIDATE_FRAGMENTATION"),
      @SerializedName("CONVERT_ASC_CP_SINGLE_INSTANCE")
      VALUE_CONVERT_ASC_CP_SINGLE_INSTANCE("CONVERT_ASC_CP_SINGLE_INSTANCE"),
      ...
      @SerializedName("ENABLE_ADVANTAGE_PLUS_AUDIENCE")
      VALUE_ENABLE_ADVANTAGE_PLUS_AUDIENCE("ENABLE_ADVANTAGE_PLUS_AUDIENCE"),
      ...
      @SerializedName("ENABLE_LANDING_PAGE_VIEWS")
      VALUE_ENABLE_LANDING_PAGE_VIEWS("ENABLE_LANDING_PAGE_VIEWS"),
      @SerializedName("ENABLE_MUSIC")
      VALUE_ENABLE_MUSIC("ENABLE_MUSIC"),
      @SerializedName("ENABLE_PIXELLESS_LPV_OPTIMIZATION_GOAL")
      VALUE_ENABLE_PIXELLESS_LPV_OPTIMIZATION_GOAL("ENABLE_PIXELLESS_LPV_OPTIMIZATION_GOAL"),
      @SerializedName("ENABLE_PRODUCT_SET_BOOSTING")
      VALUE_ENABLE_PRODUCT_SET_BOOSTING("ENABLE_PRODUCT_SET_BOOSTING"),
      @SerializedName("ENABLE_REELS_PLACEMENTS")
      VALUE_ENABLE_REELS_PLACEMENTS("ENABLE_REELS_PLACEMENTS"),
      ...
      @SerializedName("ENABLE_SHOPS_ADS_SAOFF")
      VALUE_ENABLE_SHOPS_ADS_SAOFF("ENABLE_SHOPS_ADS_SAOFF"),
      @SerializedName("ENABLE_WTWA_UPSELL_IN_DUPLICATION")
      VALUE_ENABLE_WTWA_UPSELL_IN_DUPLICATION("ENABLE_WTWA_UPSELL_IN_DUPLICATION"),
