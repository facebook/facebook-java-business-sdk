...
public class DogNotificationSettings extends APINode {
  ...
  public static class APIRequestUpdate extends APIRequest<DogNotificationSettings> {
    ...
    public APIRequestUpdate setSubscriptionStatusPerChannel (String subscriptionStatusPerChannel) {
      this.setParam("subscription_status_per_channel", subscriptionStatusPerChannel);
      return this;
    }
