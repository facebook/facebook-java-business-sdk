...
public class ConversionHealthKPI extends APINode {
  ...
  public static ConversionHealthKPI loadJSON(String json, APIContext context, String header) {
    ConversionHealthKPI conversionHealthKPI = getGson().fromJson(json, ConversionHealthKPI.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(conversionHealthKPI.toString());
  ...
  public static APINodeList<ConversionHealthKPI> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          conversionHealthKPIs.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            conversionHealthKPIs.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  conversionHealthKPIs.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              conversionHealthKPIs.add(loadJSON(obj.toString(), context, header));
            }
          }
          return conversionHealthKPIs;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              conversionHealthKPIs.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          conversionHealthKPIs.add(loadJSON(json, context, header));
          return conversionHealthKPIs;
        }
      }
    } catch (Exception e) {
  ...
  public Double getFieldImpactedBrowsersMatchRate() {
    return mImpactedBrowsersMatchRate;
  }
  ...
  public Double getFieldImpactedBrowsersMatchRateMomTrend() {
    return mImpactedBrowsersMatchRateMomTrend;
  }
  ...
  public Double getFieldImpactedBrowsersTrafficShare() {
    return mImpactedBrowsersTrafficShare;
  }
  ...
  public Double getFieldImpactedBrowsersTrafficShareMomTrend() {
    return mImpactedBrowsersTrafficShareMomTrend;
  }
  ...
  public Double getFieldMatchRateVerticalBenchmark() {
    return mMatchRateVerticalBenchmark;
  }
  ...
  public Double getFieldMatchRateVsBenchmarkMomTrend() {
    return mMatchRateVsBenchmarkMomTrend;
  }
  ...
  public static APIRequest.ResponseParser<ConversionHealthKPI> getParser() {
    return new APIRequest.ResponseParser<ConversionHealthKPI>() {
      public APINodeList<ConversionHealthKPI> parseResponse(String response, APIContext context, APIRequest<ConversionHealthKPI> request, String header) throws MalformedResponseException {
