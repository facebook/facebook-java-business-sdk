...
public class InstagramUser extends APINode {
  ...
  public static class APIRequestCreateAgency extends APIRequest<InstagramUser> {
  ...
  public static class APIRequestDeleteAssignedUsers extends APIRequest<APINode> {
    ...
    public APIRequestDeleteAssignedUsers setUser (Object user) {
  ...
  public static class APIRequestCreateAssignedUser extends APIRequest<InstagramUser> {
  ...
  public static class APIRequestCreateUserPermission extends APIRequest<InstagramUser> {
