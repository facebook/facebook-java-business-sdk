...
public class AdCreativeRewardInfo extends APINode {
  ...
  public static AdCreativeRewardInfo loadJSON(String json, APIContext context, String header) {
    AdCreativeRewardInfo adCreativeRewardInfo = getGson().fromJson(json, AdCreativeRewardInfo.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(adCreativeRewardInfo.toString());
  ...
  public static APINodeList<AdCreativeRewardInfo> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adCreativeRewardInfos.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adCreativeRewardInfos.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adCreativeRewardInfos.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              adCreativeRewardInfos.add(loadJSON(obj.toString(), context, header));
            }
          }
          return adCreativeRewardInfos;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adCreativeRewardInfos.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          adCreativeRewardInfos.add(loadJSON(json, context, header));
          return adCreativeRewardInfos;
        }
      }
    } catch (Exception e) {
  ...
  public static APIRequest.ResponseParser<AdCreativeRewardInfo> getParser() {
    return new APIRequest.ResponseParser<AdCreativeRewardInfo>() {
      public APINodeList<AdCreativeRewardInfo> parseResponse(String response, APIContext context, APIRequest<AdCreativeRewardInfo> request, String header) throws MalformedResponseException {
