...
public class AdsPixelServerToServerKey extends APINode {
  ...
  public AdsPixelServerToServerKey fetch() throws APIException{
    AdsPixelServerToServerKey newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<AdsPixelServerToServerKey> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<AdsPixelServerToServerKey>)(
      new APIRequest<AdsPixelServerToServerKey>(context, "", "/", "GET", AdsPixelServerToServerKey.getParser())
  ...
  public static ListenableFuture<APINodeList<AdsPixelServerToServerKey>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", AdsPixelServerToServerKey.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static AdsPixelServerToServerKey loadJSON(String json, APIContext context) {
    AdsPixelServerToServerKey adsPixelServerToServerKey = getGson().fromJson(json, AdsPixelServerToServerKey.class);
    if (context.isDebug()) {
  ...
  public static APINodeList<AdsPixelServerToServerKey> parseResponse(String json, APIContext context, APIRequest request) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adsPixelServerToServerKeys.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adsPixelServerToServerKeys.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adsPixelServerToServerKeys.add(loadJSON(entry.getValue().toString(), context));
                }
                break;
              }
            }
            if (!isRedownload) {
              adsPixelServerToServerKeys.add(loadJSON(obj.toString(), context));
            }
          }
          return adsPixelServerToServerKeys;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adsPixelServerToServerKeys.add(loadJSON(value.toString(), context));
            } else {
          ...
          adsPixelServerToServerKeys.add(loadJSON(json, context));
          return adsPixelServerToServerKeys;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<AdsPixelServerToServerKey> {
    ...
    public AdsPixelServerToServerKey parseResponse(String response) throws APIException {
      return AdsPixelServerToServerKey.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<AdsPixelServerToServerKey> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<String, AdsPixelServerToServerKey>() {
  ...
  public static APIRequest.ResponseParser<AdsPixelServerToServerKey> getParser() {
    return new APIRequest.ResponseParser<AdsPixelServerToServerKey>() {
      public APINodeList<AdsPixelServerToServerKey> parseResponse(String response, APIContext context, APIRequest<AdsPixelServerToServerKey> request) throws MalformedResponseException {
