...
public class ProductCatalogFacets extends APINode {
  ...
  private List<Map<String, List<Object>>> mFacets = null;
  ...
  public static ProductCatalogFacets loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(productCatalogFacets.toString());
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            productCatalogFacetss.setPaging(previous, next);
  ...
  public List<Map<String, List<Object>>> getFieldFacets() {
    return mFacets;
  }

  public ProductCatalogFacets setFieldFacets(List<Map<String, List<Object>>> value) {
    this.mFacets = value;
    return this;
  }
