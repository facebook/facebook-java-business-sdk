 ...
 *
 */
public class AdSavedKeywords extends APINode {
  ...
  public AdSavedKeywords fetch() throws APIException{
    AdSavedKeywords newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<AdSavedKeywords> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<AdSavedKeywords>)(
      new APIRequest<AdSavedKeywords>(context, "", "/", "GET", AdSavedKeywords.getParser())
  ...
  public static ListenableFuture<APINodeList<AdSavedKeywords>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", AdSavedKeywords.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static AdSavedKeywords loadJSON(String json, APIContext context, String header) {
    AdSavedKeywords adSavedKeywords = getGson().fromJson(json, AdSavedKeywords.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(adSavedKeywords.toString());
  ...
  public static APINodeList<AdSavedKeywords> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adSavedKeywordss.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adSavedKeywordss.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adSavedKeywordss.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              adSavedKeywordss.add(loadJSON(obj.toString(), context, header));
            }
          }
          return adSavedKeywordss;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adSavedKeywordss.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          adSavedKeywordss.add(loadJSON(json, context, header));
          return adSavedKeywordss;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<AdSavedKeywords> {
    ...
    public AdSavedKeywords parseResponse(String response, String header) throws APIException {
      return AdSavedKeywords.parseResponse(response, getContext(), this, header).head();
    }
    ...
    public ListenableFuture<AdSavedKeywords> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<ResponseWrapper, AdSavedKeywords>() {
           public AdSavedKeywords apply(ResponseWrapper result) {
             try {
  ...
  public static APIRequest.ResponseParser<AdSavedKeywords> getParser() {
    return new APIRequest.ResponseParser<AdSavedKeywords>() {
      public APINodeList<AdSavedKeywords> parseResponse(String response, APIContext context, APIRequest<AdSavedKeywords> request, String header) throws MalformedResponseException {
