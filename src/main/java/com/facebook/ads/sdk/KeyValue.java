...
public class KeyValue extends APINode {
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          try {
            ...
            keyValues.setPaging(paging.get("before").getAsString(), paging.get("after").getAsString());
  ...
  public KeyValue setFieldKey(String value) {
    this.mKey = value;
    return this;
  }
  ...
  public KeyValue setFieldValue(String value) {
    this.mValue = value;
    return this;
  }
