...
public class AdRuleEvaluationSpec extends APINode {
  ...
  public static class APIRequestGet extends APIRequest<AdRuleEvaluationSpec> {
    ...
    @Override
    public AdRuleEvaluationSpec parseResponse(String response) throws APIException {
      return AdRuleEvaluationSpec.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<AdRuleEvaluationSpec> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<String, AdRuleEvaluationSpec>() {
           public AdRuleEvaluationSpec apply(String result) {
             try {
