...
public class OfflineConversionDataSet extends APINode {
  ...
  public static class APIRequestGetServerEventsPermittedBusiness extends APIRequest<Business> {
    ...
    public APIRequestGetServerEventsPermittedBusiness requestWhatsappBusinessManagerMessagingLimitField () {
      return this.requestWhatsappBusinessManagerMessagingLimitField(true);
    }
    public APIRequestGetServerEventsPermittedBusiness requestWhatsappBusinessManagerMessagingLimitField (boolean value) {
      this.requestField("whatsapp_business_manager_messaging_limit", value);
      return this;
    }
  }
  ...
  public static class APIRequestGetSharedAccounts extends APIRequest<AdAccount> {
    ...
    public APIRequestGetSharedAccounts requestIsBaSkipDelayedEligibleField () {
      return this.requestIsBaSkipDelayedEligibleField(true);
    }
    public APIRequestGetSharedAccounts requestIsBaSkipDelayedEligibleField (boolean value) {
      this.requestField("is_ba_skip_delayed_eligible", value);
      return this;
    }
