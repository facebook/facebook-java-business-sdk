...
public class AdsPixelRawFiresResult extends APINode {
  ...
  public AdsPixelRawFiresResult(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public AdsPixelRawFiresResult(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public AdsPixelRawFiresResult fetch() throws APIException{
    AdsPixelRawFiresResult newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static AdsPixelRawFiresResult fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<AdsPixelRawFiresResult> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static AdsPixelRawFiresResult fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<AdsPixelRawFiresResult> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<AdsPixelRawFiresResult> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<AdsPixelRawFiresResult>)(
      new APIRequest<AdsPixelRawFiresResult>(context, "", "/", "GET", AdsPixelRawFiresResult.getParser())
  ...
  public static ListenableFuture<APINodeList<AdsPixelRawFiresResult>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", AdsPixelRawFiresResult.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adsPixelRawFiresResults.setPaging(previous, next);
  ...
  public static class APIRequestGet extends APIRequest<AdsPixelRawFiresResult> {

    AdsPixelRawFiresResult lastResponse = null;
    @Override
    public AdsPixelRawFiresResult getLastResponse() {
      return lastResponse;
    }
    ...
    @Override
    public AdsPixelRawFiresResult parseResponse(String response) throws APIException {
      return AdsPixelRawFiresResult.parseResponse(response, getContext(), this).head();
    }

    @Override
    public AdsPixelRawFiresResult execute() throws APIException {
      return execute(new HashMap<String, Object>());
    }

    @Override
    public AdsPixelRawFiresResult execute(Map<String, Object> extraParams) throws APIException {
      lastResponse = parseResponse(executeInternal(extraParams));
      return lastResponse;
    }

    public ListenableFuture<AdsPixelRawFiresResult> executeAsync() throws APIException {
      return executeAsync(new HashMap<String, Object>());
    };

    public ListenableFuture<AdsPixelRawFiresResult> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        executeAsyncInternal(extraParams),
        new Function<String, AdsPixelRawFiresResult>() {
           public AdsPixelRawFiresResult apply(String result) {
             try {
    ...
    public APIRequestGet requestPlacedUrlField () {
      return this.requestPlacedUrlField(true);
    }
    public APIRequestGet requestPlacedUrlField (boolean value) {
      this.requestField("placed_url", value);
      return this;
    }
