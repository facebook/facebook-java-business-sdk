...
public class AdAccountAdVolume extends APINode {
  ...
  public static enum EnumRecommendationType {
      ...
      @SerializedName("ADD_FUNDS_TO_RUN_CAMPAIGN")
      VALUE_ADD_FUNDS_TO_RUN_CAMPAIGN("ADD_FUNDS_TO_RUN_CAMPAIGN"),
      @SerializedName("ADOPT_CATALOG_TO_RUN_PRODUCT_CENTRIC_ADS")
      VALUE_ADOPT_CATALOG_TO_RUN_PRODUCT_CENTRIC_ADS("ADOPT_CATALOG_TO_RUN_PRODUCT_CENTRIC_ADS"),
      @SerializedName("ADOPT_CLICK_TO_FLOWS")
      VALUE_ADOPT_CLICK_TO_FLOWS("ADOPT_CLICK_TO_FLOWS"),
      @SerializedName("ADOPT_CREATIVE_AUDIENCE_PAIRING")
      VALUE_ADOPT_CREATIVE_AUDIENCE_PAIRING("ADOPT_CREATIVE_AUDIENCE_PAIRING"),
      @SerializedName("ADOPT_CREATIVE_MEDIA_SOURCING_BUNDLE")
      VALUE_ADOPT_CREATIVE_MEDIA_SOURCING_BUNDLE("ADOPT_CREATIVE_MEDIA_SOURCING_BUNDLE"),
      @SerializedName("ADOPT_CTX_RECOMMENDED_TEMPLATE_BUNDLE")
      VALUE_ADOPT_CTX_RECOMMENDED_TEMPLATE_BUNDLE("ADOPT_CTX_RECOMMENDED_TEMPLATE_BUNDLE"),
      @SerializedName("ADOPT_DAYPARTING_CTX_DEEP_CONVERSATIONS")
      VALUE_ADOPT_DAYPARTING_CTX_DEEP_CONVERSATIONS("ADOPT_DAYPARTING_CTX_DEEP_CONVERSATIONS"),
      @SerializedName("ADOPT_GEN_AI_MVP_CHILD")
      VALUE_ADOPT_GEN_AI_MVP_CHILD("ADOPT_GEN_AI_MVP_CHILD"),
      @SerializedName("ADOPT_INBOX_QUESTIONS_IN_ADS_MANAGER_CTM")
      VALUE_ADOPT_INBOX_QUESTIONS_IN_ADS_MANAGER_CTM("ADOPT_INBOX_QUESTIONS_IN_ADS_MANAGER_CTM"),
      @SerializedName("ADOPT_PRODUCT_EXTENSIONS_CHILD")
      VALUE_ADOPT_PRODUCT_EXTENSIONS_CHILD("ADOPT_PRODUCT_EXTENSIONS_CHILD"),
      @SerializedName("ADOPT_RELATED_MEDIA_SUGGESTIONS")
      VALUE_ADOPT_RELATED_MEDIA_SUGGESTIONS("ADOPT_RELATED_MEDIA_SUGGESTIONS"),
      @SerializedName("ADOPT_SINGLE_MEDIA_AD_FORMAT_BUNDLE")
      VALUE_ADOPT_SINGLE_MEDIA_AD_FORMAT_BUNDLE("ADOPT_SINGLE_MEDIA_AD_FORMAT_BUNDLE"),
      @SerializedName("ADOPT_SMS_VERIFICATION_FOR_LEAD_QUALITY")
      VALUE_ADOPT_SMS_VERIFICATION_FOR_LEAD_QUALITY("ADOPT_SMS_VERIFICATION_FOR_LEAD_QUALITY"),
      @SerializedName("ADOPT_WEBSITE_TO_MESSENGER")
      VALUE_ADOPT_WEBSITE_TO_MESSENGER("ADOPT_WEBSITE_TO_MESSENGER"),
      ...
      @SerializedName("APP_VO_IOS")
      VALUE_APP_VO_IOS("APP_VO_IOS"),
      ...
      @SerializedName("BIDCAP_TO_COSTCAP")
      VALUE_BIDCAP_TO_COSTCAP("BIDCAP_TO_COSTCAP"),
      @SerializedName("BIDCAP_TO_COSTCAP_GUIDANCE")
      VALUE_BIDCAP_TO_COSTCAP_GUIDANCE("BIDCAP_TO_COSTCAP_GUIDANCE"),
      ...
      @SerializedName("BRAND_ADVERTISER_VIDEO_FORMAT_ADS")
      VALUE_BRAND_ADVERTISER_VIDEO_FORMAT_ADS("BRAND_ADVERTISER_VIDEO_FORMAT_ADS"),
      ...
      @SerializedName("CALL_ADS_L2_DAYPARTING")
      VALUE_CALL_ADS_L2_DAYPARTING("CALL_ADS_L2_DAYPARTING"),
      ...
      @SerializedName("CAPI_PERFORMANCE_MATCH_KEY_V3")
      VALUE_CAPI_PERFORMANCE_MATCH_KEY_V3("CAPI_PERFORMANCE_MATCH_KEY_V3"),
      ...
      @SerializedName("CD_OPT_OUT_PREVENTION_GUIDANCE")
      VALUE_CD_OPT_OUT_PREVENTION_GUIDANCE("CD_OPT_OUT_PREVENTION_GUIDANCE"),
      @SerializedName("CD_OPT_OUT_PREVENTION_LOW_DURATION")
      VALUE_CD_OPT_OUT_PREVENTION_LOW_DURATION("CD_OPT_OUT_PREVENTION_LOW_DURATION"),
      ...
      @SerializedName("CONVERT_APP_WEB_FALLBACK_TO_A_DESTINATION")
      VALUE_CONVERT_APP_WEB_FALLBACK_TO_A_DESTINATION("CONVERT_APP_WEB_FALLBACK_TO_A_DESTINATION"),
      @SerializedName("CONVERT_CTX_REPLIES_TO_CTX_LEADS")
      VALUE_CONVERT_CTX_REPLIES_TO_CTX_LEADS("CONVERT_CTX_REPLIES_TO_CTX_LEADS"),
      @SerializedName("CONVERT_CTX_REPLIES_TO_CTX_PURCHASE")
      VALUE_CONVERT_CTX_REPLIES_TO_CTX_PURCHASE("CONVERT_CTX_REPLIES_TO_CTX_PURCHASE"),
      @SerializedName("CONVERT_IG_PROFILE_VISIT_TO_PTWA")
      VALUE_CONVERT_IG_PROFILE_VISIT_TO_PTWA("CONVERT_IG_PROFILE_VISIT_TO_PTWA"),
      ...
      @SerializedName("CREATIVE_AUDIENCE_PAIRING_DU")
      VALUE_CREATIVE_AUDIENCE_PAIRING_DU("CREATIVE_AUDIENCE_PAIRING_DU"),
      ...
      @SerializedName("CREATIVE_TEST")
      VALUE_CREATIVE_TEST("CREATIVE_TEST"),
      @SerializedName("CREATIVE_VOLUME")
      VALUE_CREATIVE_VOLUME("CREATIVE_VOLUME"),
      ...
      @SerializedName("CTX_ZERO_OUTCOME_BUDGET")
      VALUE_CTX_ZERO_OUTCOME_BUDGET("CTX_ZERO_OUTCOME_BUDGET"),
      ...
      @SerializedName("DUPLICATE_HIGH_PERFORMING_CAMPAIGN")
      VALUE_DUPLICATE_HIGH_PERFORMING_CAMPAIGN("DUPLICATE_HIGH_PERFORMING_CAMPAIGN"),
      ...
      @SerializedName("ENABLE_AI_GENERATED_ICEBREAKERS_FOR_CTX")
      VALUE_ENABLE_AI_GENERATED_ICEBREAKERS_FOR_CTX("ENABLE_AI_GENERATED_ICEBREAKERS_FOR_CTX"),
      @SerializedName("ENABLE_AI_GENERATED_RESPONSES_CTM")
      VALUE_ENABLE_AI_GENERATED_RESPONSES_CTM("ENABLE_AI_GENERATED_RESPONSES_CTM"),
      ...
      @SerializedName("EXPERIMENTATION_FRAMEWORK_TEST")
      VALUE_EXPERIMENTATION_FRAMEWORK_TEST("EXPERIMENTATION_FRAMEWORK_TEST"),
      ...
      @SerializedName("GENAI_FB_REELS_VIDEO")
      VALUE_GENAI_FB_REELS_VIDEO("GENAI_FB_REELS_VIDEO"),
      @SerializedName("GENERATIVE_UNCROP_DUPLICATION")
      VALUE_GENERATIVE_UNCROP_DUPLICATION("GENERATIVE_UNCROP_DUPLICATION"),
      @SerializedName("GEN_AI_FB_REELS_VIDEO")
      VALUE_GEN_AI_FB_REELS_VIDEO("GEN_AI_FB_REELS_VIDEO"),
      @SerializedName("GEN_AI_MVP")
      VALUE_GEN_AI_MVP("GEN_AI_MVP"),
      @SerializedName("GEN_AI_MVP_EXISTING_POSTS")
      VALUE_GEN_AI_MVP_EXISTING_POSTS("GEN_AI_MVP_EXISTING_POSTS"),
      @SerializedName("GES_TEST")
      VALUE_GES_TEST("GES_TEST"),
      @SerializedName("GOOGLE_ANALYTICS_INTEGRATION")
      VALUE_GOOGLE_ANALYTICS_INTEGRATION("GOOGLE_ANALYTICS_INTEGRATION"),
      ...
      @SerializedName("INCREASE_BUDGET_UNDERPOWERED_EXPERIMENTS")
      VALUE_INCREASE_BUDGET_UNDERPOWERED_EXPERIMENTS("INCREASE_BUDGET_UNDERPOWERED_EXPERIMENTS"),
      @SerializedName("INCREASE_SPEND_ON_VIDEO_CREATIVE")
      VALUE_INCREASE_SPEND_ON_VIDEO_CREATIVE("INCREASE_SPEND_ON_VIDEO_CREATIVE"),
      @SerializedName("INCREMENTAL_ATTRIBUTION")
      VALUE_INCREMENTAL_ATTRIBUTION("INCREMENTAL_ATTRIBUTION"),
      @SerializedName("INFORMED_CAMPAIGN_CREATION")
      VALUE_INFORMED_CAMPAIGN_CREATION("INFORMED_CAMPAIGN_CREATION"),
      ...
      @SerializedName("LEAD_NURTURING")
      VALUE_LEAD_NURTURING("LEAD_NURTURING"),
      @SerializedName("LEAD_NURTURING_GUIDANCE")
      VALUE_LEAD_NURTURING_GUIDANCE("LEAD_NURTURING_GUIDANCE"),
      ...
      @SerializedName("MANUAL_BIDDING_BUDGET_LIMITED")
      VALUE_MANUAL_BIDDING_BUDGET_LIMITED("MANUAL_BIDDING_BUDGET_LIMITED"),
      ...
      @SerializedName("OPT_INTO_CHAT_ON_WHATSAPP_POST_LEAD")
      VALUE_OPT_INTO_CHAT_ON_WHATSAPP_POST_LEAD("OPT_INTO_CHAT_ON_WHATSAPP_POST_LEAD"),
      @SerializedName("OPT_INTO_NUDGE_FOLLOW_UP_MESSAGES_CTM")
      VALUE_OPT_INTO_NUDGE_FOLLOW_UP_MESSAGES_CTM("OPT_INTO_NUDGE_FOLLOW_UP_MESSAGES_CTM"),
      @SerializedName("OPT_INTO_REELS_GEN_AI_VIDEO_EXPANSION")
      VALUE_OPT_INTO_REELS_GEN_AI_VIDEO_EXPANSION("OPT_INTO_REELS_GEN_AI_VIDEO_EXPANSION"),
      @SerializedName("OPT_INTO_SINGLE_MEDIA_TO_COLLECTION_ADS")
      VALUE_OPT_INTO_SINGLE_MEDIA_TO_COLLECTION_ADS("OPT_INTO_SINGLE_MEDIA_TO_COLLECTION_ADS"),
      @SerializedName("OUTCOME_FORECASTER_BID_RECOMMENDATION")
      VALUE_OUTCOME_FORECASTER_BID_RECOMMENDATION("OUTCOME_FORECASTER_BID_RECOMMENDATION"),
      ...
      @SerializedName("PLACEMENTS_BUNDLE")
      VALUE_PLACEMENTS_BUNDLE("PLACEMENTS_BUNDLE"),
      ...
      @SerializedName("POST_ADOPTION_BUDGET_SCALING")
      VALUE_POST_ADOPTION_BUDGET_SCALING("POST_ADOPTION_BUDGET_SCALING"),
      @SerializedName("POST_FLIGHT_SCALE_GOOD_CAMPAIGN")
      VALUE_POST_FLIGHT_SCALE_GOOD_CAMPAIGN("POST_FLIGHT_SCALE_GOOD_CAMPAIGN"),
      ...
      @SerializedName("PRODUCT_EXTENSIONS_IMAGE_TO_CAROUSEL")
      VALUE_PRODUCT_EXTENSIONS_IMAGE_TO_CAROUSEL("PRODUCT_EXTENSIONS_IMAGE_TO_CAROUSEL"),
      ...
      @SerializedName("RESOLVE_UNAVAILABLE_EVENT_OPTIMIZATION")
      VALUE_RESOLVE_UNAVAILABLE_EVENT_OPTIMIZATION("RESOLVE_UNAVAILABLE_EVENT_OPTIMIZATION"),
      ...
      @SerializedName("SCALE_GOOD_VALUE_OPTIMIZATION_CAMPAIGN")
      VALUE_SCALE_GOOD_VALUE_OPTIMIZATION_CAMPAIGN("SCALE_GOOD_VALUE_OPTIMIZATION_CAMPAIGN"),
      ...
      @SerializedName("SINGLE_CELL_LIFT_STUDY")
      VALUE_SINGLE_CELL_LIFT_STUDY("SINGLE_CELL_LIFT_STUDY"),
      ...
      @SerializedName("SMART_DEFAULT_VALUE_RULES")
      VALUE_SMART_DEFAULT_VALUE_RULES("SMART_DEFAULT_VALUE_RULES"),
      @SerializedName("SMB_DUPLICATION")
      VALUE_SMB_DUPLICATION("SMB_DUPLICATION"),
      @SerializedName("SMB_SGC_DUPLICATION")
      VALUE_SMB_SGC_DUPLICATION("SMB_SGC_DUPLICATION"),
      @SerializedName("SMS_OTP_VERIFICATION_UPSELL")
      VALUE_SMS_OTP_VERIFICATION_UPSELL("SMS_OTP_VERIFICATION_UPSELL"),
      @SerializedName("SPEND_LIMIT")
      VALUE_SPEND_LIMIT("SPEND_LIMIT"),
      @SerializedName("SUPPORT_CTM_ADS_WITH_CUSTOMER_ACTIONS")
      VALUE_SUPPORT_CTM_ADS_WITH_CUSTOMER_ACTIONS("SUPPORT_CTM_ADS_WITH_CUSTOMER_ACTIONS"),
      ...
      @SerializedName("THREECO_WEB_PLUS_APP_APLUSD")
      VALUE_THREECO_WEB_PLUS_APP_APLUSD("THREECO_WEB_PLUS_APP_APLUSD"),
      ...
      @SerializedName("TRANSLATION_DEFAULT_ON")
      VALUE_TRANSLATION_DEFAULT_ON("TRANSLATION_DEFAULT_ON"),
      ...
      @SerializedName("UPGRADE_DURATION_SETTINGS_FOR_DUPLICATION")
      VALUE_UPGRADE_DURATION_SETTINGS_FOR_DUPLICATION("UPGRADE_DURATION_SETTINGS_FOR_DUPLICATION"),
      ...
      @SerializedName("UPSELL_SOFT_OPT_OUT_TO_NON_APLUS_P")
      VALUE_UPSELL_SOFT_OPT_OUT_TO_NON_APLUS_P("UPSELL_SOFT_OPT_OUT_TO_NON_APLUS_P"),
      ...
      @SerializedName("WEBSITE_TO_MESSENGER")
      VALUE_WEBSITE_TO_MESSENGER("WEBSITE_TO_MESSENGER"),
      @SerializedName("WEB_APP_CONVERSION")
      VALUE_WEB_APP_CONVERSION("WEB_APP_CONVERSION"),
      ...
      @SerializedName("ZIJI_SGP_UGP_TEST")
      VALUE_ZIJI_SGP_UGP_TEST("ZIJI_SGP_UGP_TEST"),
      ;
