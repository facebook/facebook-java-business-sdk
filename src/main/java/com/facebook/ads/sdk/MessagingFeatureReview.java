...
public class MessagingFeatureReview extends APINode {
  ...
  public static MessagingFeatureReview loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(messagingFeatureReview.toString());
  ...
  public MessagingFeatureReview setFieldFeature(String value) {
    this.mFeature = value;
    return this;
  }
  ...
  public MessagingFeatureReview setFieldStatus(String value) {
    this.mStatus = value;
    return this;
  }
