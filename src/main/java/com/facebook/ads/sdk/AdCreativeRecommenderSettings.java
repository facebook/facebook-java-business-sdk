...
public class AdCreativeRecommenderSettings extends APINode {
  ...
  public static AdCreativeRecommenderSettings loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(adCreativeRecommenderSettings.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                adCreativeRecommenderSettingss.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            adCreativeRecommenderSettingss.setPaging(previous, next);
            if (context.hasAppSecret()) {
              adCreativeRecommenderSettingss.setAppSecret(context.getAppSecretProof());
            }
          }
