...
public class AdRuleHistoryResult extends APINode {
  ...
  public AdRuleHistoryResult(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public AdRuleHistoryResult(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public AdRuleHistoryResult fetch() throws APIException{
    AdRuleHistoryResult newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static AdRuleHistoryResult fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<AdRuleHistoryResult> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static AdRuleHistoryResult fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<AdRuleHistoryResult> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<AdRuleHistoryResult> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<AdRuleHistoryResult>)(
      new APIRequest<AdRuleHistoryResult>(context, "", "/", "GET", AdRuleHistoryResult.getParser())
  ...
  public static ListenableFuture<APINodeList<AdRuleHistoryResult>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", AdRuleHistoryResult.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adRuleHistoryResults.setPaging(previous, next);
  ...
  public static class APIRequestGet extends APIRequest<AdRuleHistoryResult> {

    AdRuleHistoryResult lastResponse = null;
    @Override
    public AdRuleHistoryResult getLastResponse() {
      return lastResponse;
    }
    ...
    @Override
    public AdRuleHistoryResult parseResponse(String response) throws APIException {
      return AdRuleHistoryResult.parseResponse(response, getContext(), this).head();
    }

    @Override
    public AdRuleHistoryResult execute() throws APIException {
      return execute(new HashMap<String, Object>());
    }

    @Override
    public AdRuleHistoryResult execute(Map<String, Object> extraParams) throws APIException {
      lastResponse = parseResponse(executeInternal(extraParams));
      return lastResponse;
    }

    public ListenableFuture<AdRuleHistoryResult> executeAsync() throws APIException {
      return executeAsync(new HashMap<String, Object>());
    };

    public ListenableFuture<AdRuleHistoryResult> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        executeAsyncInternal(extraParams),
        new Function<String, AdRuleHistoryResult>() {
           public AdRuleHistoryResult apply(String result) {
             try {
