...
public class AtlasCampaign extends APINode {
  ...
  public APIRequestCreateImportTemplate createImportTemplate() {
    return new APIRequestCreateImportTemplate(this.getPrefixedId().toString(), context);
  }
  ...
  public static class APIRequestCreateImportTemplate extends APIRequest<AtlasCampaign> {
      ...
      return Futures.transform(
        ...
        new Function<ResponseWrapper, AtlasCampaign>() {
           public AtlasCampaign apply(ResponseWrapper result) {
             try {
               return APIRequestCreateImportTemplate.this.parseResponse(result.getBody(), result.getHeader());
             } catch (Exception e) {
               throw new RuntimeException(e);
             }
           }
    ...
    public APIRequestCreateImportTemplate(String nodeId, APIContext context) {
      super(context, nodeId, "/importtemplate", "POST", Arrays.asList(PARAMS));
    }

    @Override
    public APIRequestCreateImportTemplate setParam(String param, Object value) {
      setParamInternal(param, value);
      return this;
    }

    @Override
    public APIRequestCreateImportTemplate setParams(Map<String, Object> params) {
      setParamsInternal(params);
      return this;
    }


    public APIRequestCreateImportTemplate setExport (String export) {
      this.setParam("export", export);
      return this;
    }

    public APIRequestCreateImportTemplate setFilename (String filename) {
      this.setParam("filename", filename);
      return this;
    }

    public APIRequestCreateImportTemplate setFormat (String format) {
      this.setParam("format", format);
      return this;
    }

    public APIRequestCreateImportTemplate setTemplate (String template) {
      this.setParam("template", template);
      return this;
    }

    public APIRequestCreateImportTemplate requestAllFields () {
      return this.requestAllFields(true);
    }

    public APIRequestCreateImportTemplate requestAllFields (boolean value) {
      for (String field : FIELDS) {
        this.requestField(field, value);
      }
      return this;
    ...
    @Override
    public APIRequestCreateImportTemplate requestFields (List<String> fields) {
      return this.requestFields(fields, true);
    }

    @Override
    public APIRequestCreateImportTemplate requestFields (List<String> fields, boolean value) {
      for (String field : fields) {
        this.requestField(field, value);
      }
      return this;
    ...
    @Override
    public APIRequestCreateImportTemplate requestField (String field) {
      this.requestField(field, true);
      return this;
    }

    @Override
    public APIRequestCreateImportTemplate requestField (String field, boolean value) {
      this.requestFieldInternal(field, value);
      return this;
    }
