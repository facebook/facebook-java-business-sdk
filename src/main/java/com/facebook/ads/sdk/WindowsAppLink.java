...
public class WindowsAppLink extends APINode {
  ...
  public static WindowsAppLink loadJSON(String json, APIContext context) {
    ...
    windowsAppLink.mContext = context;
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          try {
            ...
            windowsAppLinks.setPaging(paging.get("before").getAsString(), paging.get("after").getAsString());
  ...
  public static APIRequest.ResponseParser<WindowsAppLink> getParser() {
    return new APIRequest.ResponseParser<WindowsAppLink>() {
      public APINodeList<WindowsAppLink> parseResponse(String response, APIContext context, APIRequest<WindowsAppLink> request) {
