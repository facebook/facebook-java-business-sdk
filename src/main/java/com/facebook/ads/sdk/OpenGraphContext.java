...
public class OpenGraphContext extends APINode {
  ...
  public static class APIRequestGetFriendsWhoLike extends APIRequest<User> {
    ...
    public APIRequestGetFriendsWhoLike requestEmployeeNumberField () {
      return this.requestEmployeeNumberField(true);
    }
    public APIRequestGetFriendsWhoLike requestEmployeeNumberField (boolean value) {
      this.requestField("employee_number", value);
      return this;
    }
    ...
    public APIRequestGetFriendsWhoLike requestLabelsField () {
      return this.requestLabelsField(true);
    }
    public APIRequestGetFriendsWhoLike requestLabelsField (boolean value) {
      this.requestField("labels", value);
      return this;
    }
