...
public class DraftPost extends APINode {
  ...
  public static DraftPost loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(draftPost.toString());
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            draftPosts.setPaging(previous, next);
  ...
  public DraftPost setFieldIsPostInGoodState(Boolean value) {
  ...
  public DraftPost setFieldScheduledFailureNotice(String value) {
