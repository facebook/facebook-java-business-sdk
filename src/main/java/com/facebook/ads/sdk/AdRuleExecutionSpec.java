...
public class AdRuleExecutionSpec extends APINode {
  ...
  public static AdRuleExecutionSpec loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(adRuleExecutionSpec.toString());
  ...
  public static enum EnumExecutionType {
      ...
      @SerializedName("AD_RECOMMENDATION_APPLY")
      VALUE_AD_RECOMMENDATION_APPLY("AD_RECOMMENDATION_APPLY"),
