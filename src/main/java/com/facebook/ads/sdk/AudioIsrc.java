 ...
 *
 */
public class AudioIsrc extends APINode {
  @SerializedName("all_kg_featured_artists")
  private String mAllKgFeaturedArtists = null;
  @SerializedName("all_kg_main_artists")
  ...
  @SerializedName("publishing_rights_data")
  private Object mPublishingRightsData = null;
  @SerializedName("top_searchable_artist_id")
  private String mTopSearchableArtistId = null;
  @SerializedName("top_searchable_artist_name")
  private String mTopSearchableArtistName = null;
  @SerializedName("top_searchable_artist_profile_pic_url")
  ...
  public AudioIsrc fetch() throws APIException{
    AudioIsrc newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<AudioIsrc> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<AudioIsrc>)(
      new APIRequest<AudioIsrc>(context, "", "/", "GET", AudioIsrc.getParser())
  ...
  public static ListenableFuture<APINodeList<AudioIsrc>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", AudioIsrc.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static AudioIsrc loadJSON(String json, APIContext context, String header) {
    AudioIsrc audioIsrc = getGson().fromJson(json, AudioIsrc.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(audioIsrc.toString());
  ...
  public static APINodeList<AudioIsrc> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          audioIsrcs.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        return audioIsrcs;
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            audioIsrcs.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  audioIsrcs.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              audioIsrcs.add(loadJSON(obj.toString(), context, header));
            }
          }
          return audioIsrcs;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              audioIsrcs.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          audioIsrcs.clear();
          audioIsrcs.add(loadJSON(json, context, header));
          return audioIsrcs;
        }
      }
    } catch (Exception e) {
  ...
  public String getFieldAllKgFeaturedArtists() {
    return mAllKgFeaturedArtists;
  }

  public String getFieldAllKgMainArtists() {
    return mAllKgMainArtists;
  }
  ...
  public Object getFieldPublishingRightsData() {
    return mPublishingRightsData;
  }

  public String getFieldTopSearchableArtistId() {
    return mTopSearchableArtistId;
  }

  public String getFieldTopSearchableArtistName() {
    return mTopSearchableArtistName;
  }

  public String getFieldTopSearchableArtistProfilePicUrl() {
    return mTopSearchableArtistProfilePicUrl;
  }



  public static class APIRequestGet extends APIRequest<AudioIsrc> {
    ...
    public AudioIsrc parseResponse(String response, String header) throws APIException {
      return AudioIsrc.parseResponse(response, getContext(), this, header).head();
    }
    ...
    public ListenableFuture<AudioIsrc> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<ResponseWrapper, AudioIsrc>() {
           public AudioIsrc apply(ResponseWrapper result) {
             try {
  ...
  public static APIRequest.ResponseParser<AudioIsrc> getParser() {
    return new APIRequest.ResponseParser<AudioIsrc>() {
      public APINodeList<AudioIsrc> parseResponse(String response, APIContext context, APIRequest<AudioIsrc> request, String header) throws MalformedResponseException {
