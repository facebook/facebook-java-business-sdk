 ...
 *
 */
public class SiteLink extends APINode {
  @SerializedName("id")
  ...
  public SiteLink fetch() throws APIException{
    SiteLink newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<SiteLink> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<SiteLink>)(
      new APIRequest<SiteLink>(context, "", "/", "GET", SiteLink.getParser())
  ...
  public static ListenableFuture<APINodeList<SiteLink>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", SiteLink.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static SiteLink loadJSON(String json, APIContext context, String header) {
    SiteLink siteLink = getGson().fromJson(json, SiteLink.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(siteLink.toString());
  ...
  public static APINodeList<SiteLink> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          siteLinks.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        return siteLinks;
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            siteLinks.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  siteLinks.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              siteLinks.add(loadJSON(obj.toString(), context, header));
            }
          }
          return siteLinks;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              siteLinks.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          siteLinks.clear();
          siteLinks.add(loadJSON(json, context, header));
          return siteLinks;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<SiteLink> {
    ...
    public SiteLink parseResponse(String response, String header) throws APIException {
      return SiteLink.parseResponse(response, getContext(), this, header).head();
    }
    ...
    public ListenableFuture<SiteLink> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<ResponseWrapper, SiteLink>() {
           public SiteLink apply(ResponseWrapper result) {
             try {
  ...
  public static APIRequest.ResponseParser<SiteLink> getParser() {
    return new APIRequest.ResponseParser<SiteLink>() {
      public APINodeList<SiteLink> parseResponse(String response, APIContext context, APIRequest<SiteLink> request, String header) throws MalformedResponseException {
