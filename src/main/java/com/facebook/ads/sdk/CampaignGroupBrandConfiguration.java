...
public class CampaignGroupBrandConfiguration extends APINode {
  @SerializedName("brand_product_name")
  private String mBrandProductName = null;
  ...
  public static CampaignGroupBrandConfiguration loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(campaignGroupBrandConfiguration.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                campaignGroupBrandConfigurations.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            campaignGroupBrandConfigurations.setPaging(previous, next);
            if (context.hasAppSecret()) {
              campaignGroupBrandConfigurations.setAppSecret(context.getAppSecretProof());
            }
          }
