...
public class DirectDebit extends APINode {
  ...
  public static APINodeList<DirectDebit> parseResponse(String json, APIContext context, APIRequest request) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          directDebits.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context));
        };
        return directDebits;
        ...
        if (obj.has("data")) {
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  directDebits.add(loadJSON(entry.getValue().toString(), context));
                }
                break;
              }
            }
            if (!isRedownload) {
              directDebits.add(loadJSON(obj.toString(), context));
            }
          }
          return directDebits;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              directDebits.add(loadJSON(value.toString(), context));
            } else {
          ...
          directDebits.clear();
          directDebits.add(loadJSON(json, context));
          return directDebits;
        }
      }
    } catch (Exception e) {
  ...
  public static APIRequest.ResponseParser<DirectDebit> getParser() {
    return new APIRequest.ResponseParser<DirectDebit>() {
      public APINodeList<DirectDebit> parseResponse(String response, APIContext context, APIRequest<DirectDebit> request) throws MalformedResponseException {
