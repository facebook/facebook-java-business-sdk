...
public class TargetingSentenceLine extends APINode {
  ...
  public TargetingSentenceLine(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public TargetingSentenceLine(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public TargetingSentenceLine fetch() throws APIException{
    TargetingSentenceLine newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static TargetingSentenceLine fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<TargetingSentenceLine> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static TargetingSentenceLine fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<TargetingSentenceLine> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<TargetingSentenceLine> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<TargetingSentenceLine>)(
      new APIRequest<TargetingSentenceLine>(context, "", "/", "GET", TargetingSentenceLine.getParser())
  ...
  public static ListenableFuture<APINodeList<TargetingSentenceLine>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", TargetingSentenceLine.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static class APIRequestGet extends APIRequest<TargetingSentenceLine> {

    TargetingSentenceLine lastResponse = null;
    @Override
    public TargetingSentenceLine getLastResponse() {
      return lastResponse;
    }
    ...
    @Override
    public TargetingSentenceLine parseResponse(String response) throws APIException {
      return TargetingSentenceLine.parseResponse(response, getContext(), this).head();
    }

    @Override
    public TargetingSentenceLine execute() throws APIException {
      return execute(new HashMap<String, Object>());
    }

    @Override
    public TargetingSentenceLine execute(Map<String, Object> extraParams) throws APIException {
      lastResponse = parseResponse(executeInternal(extraParams));
      return lastResponse;
    }

    public ListenableFuture<TargetingSentenceLine> executeAsync() throws APIException {
      return executeAsync(new HashMap<String, Object>());
    };

    public ListenableFuture<TargetingSentenceLine> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        executeAsyncInternal(extraParams),
        new Function<String, TargetingSentenceLine>() {
           public TargetingSentenceLine apply(String result) {
             try {
    ...
    public APIRequestGet requestTargetingsentencelinesField () {
      return this.requestTargetingsentencelinesField(true);
    }
    public APIRequestGet requestTargetingsentencelinesField (boolean value) {
