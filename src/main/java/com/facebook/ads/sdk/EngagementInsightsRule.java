...
public class EngagementInsightsRule extends APINode {
  ...
  public static APINodeList<EngagementInsightsRule> parseResponse(String json, APIContext context, APIRequest request) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          engagementInsightsRules.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context));
        };
        ...
        if (obj.has("data")) {
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  engagementInsightsRules.add(loadJSON(entry.getValue().toString(), context));
                }
                break;
              }
            }
            if (!isRedownload) {
              engagementInsightsRules.add(loadJSON(obj.toString(), context));
            }
          }
          return engagementInsightsRules;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              engagementInsightsRules.add(loadJSON(value.toString(), context));
            } else {
          ...
          engagementInsightsRules.add(loadJSON(json, context));
          return engagementInsightsRules;
        }
      }
    } catch (Exception e) {
  ...
  public static APIRequest.ResponseParser<EngagementInsightsRule> getParser() {
    return new APIRequest.ResponseParser<EngagementInsightsRule>() {
      public APINodeList<EngagementInsightsRule> parseResponse(String response, APIContext context, APIRequest<EngagementInsightsRule> request) throws MalformedResponseException {
