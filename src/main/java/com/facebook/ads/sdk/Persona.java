 ...
 *
 */
public class Persona extends APINode {
  @SerializedName("id")
  ...
  public Persona(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public Persona(String id, APIContext context) {
    this.mId = id;
    this.context = context;
  }

  public Persona fetch() throws APIException{
    Persona newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static Persona fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<Persona> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static Persona fetchById(String id, APIContext context) throws APIException {
    Persona persona =
  ...
  public static ListenableFuture<Persona> fetchByIdAsync(String id, APIContext context) throws APIException {
    ListenableFuture<Persona> persona =
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
    return persona;
  ...
  public static APINodeList<Persona> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<Persona>)(
      new APIRequest<Persona>(context, "", "/", "GET", Persona.getParser())
  ...
  public static ListenableFuture<APINodeList<Persona>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    ListenableFuture<APINodeList<Persona>> persona =
      new APIRequest(context, "", "/", "GET", Persona.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
    return persona;
  ...
  public static Persona loadJSON(String json, APIContext context) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = parser.parse(persona.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                personas.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            personas.setPaging(previous, next);
          }
  ...
  public static class APIRequestGet extends APIRequest<Persona> {
  ...
  public Persona copyFrom(Persona instance) {
