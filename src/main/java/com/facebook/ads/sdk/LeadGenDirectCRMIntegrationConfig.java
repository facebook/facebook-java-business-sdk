 ...
 *
 */
public class LeadGenDirectCRMIntegrationConfig extends APINode {
  ...
  @SerializedName("matched_fields_labels")
  ...
  public LeadGenDirectCRMIntegrationConfig fetch() throws APIException{
    LeadGenDirectCRMIntegrationConfig newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<LeadGenDirectCRMIntegrationConfig> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<LeadGenDirectCRMIntegrationConfig>)(
      new APIRequest<LeadGenDirectCRMIntegrationConfig>(context, "", "/", "GET", LeadGenDirectCRMIntegrationConfig.getParser())
  ...
  public static ListenableFuture<APINodeList<LeadGenDirectCRMIntegrationConfig>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", LeadGenDirectCRMIntegrationConfig.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static LeadGenDirectCRMIntegrationConfig loadJSON(String json, APIContext context, String header) {
    LeadGenDirectCRMIntegrationConfig leadGenDirectCRMIntegrationConfig = getGson().fromJson(json, LeadGenDirectCRMIntegrationConfig.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(leadGenDirectCRMIntegrationConfig.toString());
  ...
  public static APINodeList<LeadGenDirectCRMIntegrationConfig> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          leadGenDirectCRMIntegrationConfigs.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            leadGenDirectCRMIntegrationConfigs.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  leadGenDirectCRMIntegrationConfigs.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              leadGenDirectCRMIntegrationConfigs.add(loadJSON(obj.toString(), context, header));
            }
          }
          return leadGenDirectCRMIntegrationConfigs;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              leadGenDirectCRMIntegrationConfigs.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          leadGenDirectCRMIntegrationConfigs.add(loadJSON(json, context, header));
          return leadGenDirectCRMIntegrationConfigs;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<LeadGenDirectCRMIntegrationConfig> {
    ...
    public LeadGenDirectCRMIntegrationConfig parseResponse(String response, String header) throws APIException {
      return LeadGenDirectCRMIntegrationConfig.parseResponse(response, getContext(), this, header).head();
    }
    ...
    public ListenableFuture<LeadGenDirectCRMIntegrationConfig> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<ResponseWrapper, LeadGenDirectCRMIntegrationConfig>() {
           public LeadGenDirectCRMIntegrationConfig apply(ResponseWrapper result) {
             try {
  ...
  public static APIRequest.ResponseParser<LeadGenDirectCRMIntegrationConfig> getParser() {
    return new APIRequest.ResponseParser<LeadGenDirectCRMIntegrationConfig>() {
      public APINodeList<LeadGenDirectCRMIntegrationConfig> parseResponse(String response, APIContext context, APIRequest<LeadGenDirectCRMIntegrationConfig> request, String header) throws MalformedResponseException {
