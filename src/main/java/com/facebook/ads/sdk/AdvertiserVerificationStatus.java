...
public class AdvertiserVerificationStatus extends APINode {
  ...
  public static AdvertiserVerificationStatus loadJSON(String json, APIContext context, String header) {
    AdvertiserVerificationStatus advertiserVerificationStatus = getGson().fromJson(json, AdvertiserVerificationStatus.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(advertiserVerificationStatus.toString());
  ...
  public static APINodeList<AdvertiserVerificationStatus> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          advertiserVerificationStatuss.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            advertiserVerificationStatuss.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  advertiserVerificationStatuss.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              advertiserVerificationStatuss.add(loadJSON(obj.toString(), context, header));
            }
          }
          return advertiserVerificationStatuss;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              advertiserVerificationStatuss.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          advertiserVerificationStatuss.add(loadJSON(json, context, header));
          return advertiserVerificationStatuss;
        }
      }
    } catch (Exception e) {
  ...
  public static APIRequest.ResponseParser<AdvertiserVerificationStatus> getParser() {
    return new APIRequest.ResponseParser<AdvertiserVerificationStatus>() {
      public APINodeList<AdvertiserVerificationStatus> parseResponse(String response, APIContext context, APIRequest<AdvertiserVerificationStatus> request, String header) throws MalformedResponseException {
