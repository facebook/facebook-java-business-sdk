 ...
 *
 */
public class BusinessMatchedSearchApplicationsEdgeData extends APINode {
  ...
  public static BusinessMatchedSearchApplicationsEdgeData loadJSON(String json, APIContext context) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = parser.parse(businessMatchedSearchApplicationsEdgeData.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                businessMatchedSearchApplicationsEdgeDatas.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            businessMatchedSearchApplicationsEdgeDatas.setPaging(previous, next);
            if (context.hasAppSecret()) {
              businessMatchedSearchApplicationsEdgeDatas.setAppSecret(context.getAppSecretProof());
            }
          }
  ...
  public BusinessMatchedSearchApplicationsEdgeData copyFrom(BusinessMatchedSearchApplicationsEdgeData instance) {
