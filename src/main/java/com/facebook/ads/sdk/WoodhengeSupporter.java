 ...
 *
 */
public class WoodhengeSupporter extends APINode {
  @SerializedName("creation_time")
  private String mCreationTime = null;
  @SerializedName("id")
  private String mId = null;
  @SerializedName("is_gifted_subscription")
  private Boolean mIsGiftedSubscription = null;
  @SerializedName("most_recent_subscription_time")
  private String mMostRecentSubscriptionTime = null;
  @SerializedName("number_of_months_subscribed")
  ...
  public WoodhengeSupporter fetch() throws APIException{
    WoodhengeSupporter newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<WoodhengeSupporter> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<WoodhengeSupporter>)(
      new APIRequest<WoodhengeSupporter>(context, "", "/", "GET", WoodhengeSupporter.getParser())
  ...
  public static ListenableFuture<APINodeList<WoodhengeSupporter>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", WoodhengeSupporter.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static WoodhengeSupporter loadJSON(String json, APIContext context, String header) {
    WoodhengeSupporter woodhengeSupporter = getGson().fromJson(json, WoodhengeSupporter.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(woodhengeSupporter.toString());
  ...
  public static APINodeList<WoodhengeSupporter> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          woodhengeSupporters.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            woodhengeSupporters.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  woodhengeSupporters.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              woodhengeSupporters.add(loadJSON(obj.toString(), context, header));
            }
          }
          return woodhengeSupporters;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              woodhengeSupporters.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          woodhengeSupporters.add(loadJSON(json, context, header));
          return woodhengeSupporters;
        }
      }
    } catch (Exception e) {
  ...
  public Boolean getFieldIsGiftedSubscription() {
    return mIsGiftedSubscription;
  }

  public String getFieldMostRecentSubscriptionTime() {
    return mMostRecentSubscriptionTime;
  }

  public Long getFieldNumberOfMonthsSubscribed() {
    return mNumberOfMonthsSubscribed;
  }
  ...
  public static class APIRequestGet extends APIRequest<WoodhengeSupporter> {
    ...
    public WoodhengeSupporter parseResponse(String response, String header) throws APIException {
      return WoodhengeSupporter.parseResponse(response, getContext(), this, header).head();
    }
    ...
    public ListenableFuture<WoodhengeSupporter> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<ResponseWrapper, WoodhengeSupporter>() {
           public WoodhengeSupporter apply(ResponseWrapper result) {
             try {
  ...
  public static APIRequest.ResponseParser<WoodhengeSupporter> getParser() {
    return new APIRequest.ResponseParser<WoodhengeSupporter>() {
      public APINodeList<WoodhengeSupporter> parseResponse(String response, APIContext context, APIRequest<WoodhengeSupporter> request, String header) throws MalformedResponseException {
