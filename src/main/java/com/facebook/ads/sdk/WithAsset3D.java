 ...
 *
 */
public class WithAsset3D extends APINode {
  @SerializedName("id")
  ...
  public WithAsset3D(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public WithAsset3D(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public WithAsset3D fetch() throws APIException{
    WithAsset3D newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static WithAsset3D fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<WithAsset3D> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static WithAsset3D fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<WithAsset3D> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<WithAsset3D> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<WithAsset3D>)(
      new APIRequest<WithAsset3D>(context, "", "/", "GET", WithAsset3D.getParser())
  ...
  public static ListenableFuture<APINodeList<WithAsset3D>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", WithAsset3D.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                withAsset3Ds.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            withAsset3Ds.setPaging(previous, next);
            if (context.hasAppSecret()) {
              withAsset3Ds.setAppSecret(context.getAppSecretProof());
            }
          }
  ...
  public static class APIRequestGet extends APIRequest<WithAsset3D> {

    WithAsset3D lastResponse = null;
    @Override
    public WithAsset3D getLastResponse() {
      return lastResponse;
    }
    ...
    @Override
    public WithAsset3D execute() throws APIException {
    ...
    public ListenableFuture<WithAsset3D> executeAsync() throws APIException {
  ...
  public WithAsset3D copyFrom(WithAsset3D instance) {
