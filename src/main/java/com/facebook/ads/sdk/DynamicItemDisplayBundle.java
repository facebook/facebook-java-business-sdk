...
public class DynamicItemDisplayBundle extends APINode {
  ...
  private List<Map<String, String>> mAdditionalUrls = null;
  ...
  private List<Map<String, String>> mTextTokens = null;
  @SerializedName("url")
  ...
  public static DynamicItemDisplayBundle loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(dynamicItemDisplayBundle.toString());
  ...
  public List<Map<String, String>> getFieldAdditionalUrls() {
  ...
  public List<Map<String, String>> getFieldTextTokens() {
    return mTextTokens;
  }
