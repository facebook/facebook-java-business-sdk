 ...
 *
 */
public class AdLimitsEnforcementData extends APINode {
  @SerializedName("ad_limit_on_page")
  private Long mAdLimitOnPage = null;
  @SerializedName("ad_limit_on_scope")
  private Long mAdLimitOnScope = null;
  @SerializedName("ad_volume_on_page")
  private Long mAdVolumeOnPage = null;
  @SerializedName("ad_volume_on_scope")
  ...
  public static AdLimitsEnforcementData loadJSON(String json, APIContext context, String header) {
    AdLimitsEnforcementData adLimitsEnforcementData = getGson().fromJson(json, AdLimitsEnforcementData.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(adLimitsEnforcementData.toString());
  ...
  public static APINodeList<AdLimitsEnforcementData> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adLimitsEnforcementDatas.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adLimitsEnforcementDatas.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adLimitsEnforcementDatas.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              adLimitsEnforcementDatas.add(loadJSON(obj.toString(), context, header));
            }
          }
          return adLimitsEnforcementDatas;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adLimitsEnforcementDatas.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          adLimitsEnforcementDatas.add(loadJSON(json, context, header));
          return adLimitsEnforcementDatas;
        }
      }
    } catch (Exception e) {
  ...
  public static APIRequest.ResponseParser<AdLimitsEnforcementData> getParser() {
    return new APIRequest.ResponseParser<AdLimitsEnforcementData>() {
      public APINodeList<AdLimitsEnforcementData> parseResponse(String response, APIContext context, APIRequest<AdLimitsEnforcementData> request, String header) throws MalformedResponseException {
