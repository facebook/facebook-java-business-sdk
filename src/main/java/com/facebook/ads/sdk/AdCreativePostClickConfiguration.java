 ...
 *
 */
public class AdCreativePostClickConfiguration extends APINode {
  @SerializedName("post_click_item_description")
  ...
  public static AdCreativePostClickConfiguration loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(adCreativePostClickConfiguration.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                adCreativePostClickConfigurations.setCursors(before, after);
            }
