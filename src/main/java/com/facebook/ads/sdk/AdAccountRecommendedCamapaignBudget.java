...
public class AdAccountRecommendedCamapaignBudget extends APINode {
  ...
  public static AdAccountRecommendedCamapaignBudget loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(adAccountRecommendedCamapaignBudget.toString());
  ...
  public AdAccountRecommendedCamapaignBudget setFieldDaily(String value) {
    this.mDaily = value;
    return this;
  }
  ...
  public AdAccountRecommendedCamapaignBudget setFieldLifetime(String value) {
  ...
  public AdAccountRecommendedCamapaignBudget setFieldObjective(String value) {
