 ...
 *
 */
public class AdsSignalDiagnosticIssue extends APINode {
  ...
  @SerializedName("traffic_anomaly_drop_percentage")
  private Double mTrafficAnomalyDropPercentage = null;
  @SerializedName("traffic_anomaly_drop_timestamp")
  private String mTrafficAnomalyDropTimestamp = null;
  protected static Gson gson = null;

  public AdsSignalDiagnosticIssue() {
  }
  ...
  public static AdsSignalDiagnosticIssue loadJSON(String json, APIContext context, String header) {
    AdsSignalDiagnosticIssue adsSignalDiagnosticIssue = getGson().fromJson(json, AdsSignalDiagnosticIssue.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(adsSignalDiagnosticIssue.toString());
  ...
  public static APINodeList<AdsSignalDiagnosticIssue> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adsSignalDiagnosticIssues.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adsSignalDiagnosticIssues.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adsSignalDiagnosticIssues.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              adsSignalDiagnosticIssues.add(loadJSON(obj.toString(), context, header));
            }
          }
          return adsSignalDiagnosticIssues;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adsSignalDiagnosticIssues.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          adsSignalDiagnosticIssues.add(loadJSON(json, context, header));
          return adsSignalDiagnosticIssues;
        }
      }
    } catch (Exception e) {
  ...
  public AdsPixel getFieldDataSourceId() {
    if (mDataSourceId != null) {
      mDataSourceId.context = getContext();
    }
  ...
  public AdsSignalDiagnosticIssue setFieldDataSourceId(String value) {
    ...
    this.mDataSourceId = AdsPixel.getGson().fromJson(value, type);
    return this;
  }
  ...
  public Double getFieldTrafficAnomalyDropPercentage() {
    return mTrafficAnomalyDropPercentage;
  }
  ...
  public String getFieldTrafficAnomalyDropTimestamp() {
    return mTrafficAnomalyDropTimestamp;
  }
  ...
  public static APIRequest.ResponseParser<AdsSignalDiagnosticIssue> getParser() {
    return new APIRequest.ResponseParser<AdsSignalDiagnosticIssue>() {
      public APINodeList<AdsSignalDiagnosticIssue> parseResponse(String response, APIContext context, APIRequest<AdsSignalDiagnosticIssue> request, String header) throws MalformedResponseException {
