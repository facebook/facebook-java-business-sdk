 ...
 *
 */
public class UserNuxStatuses extends APINode {
  @SerializedName("max_views")
  private Long mMaxViews = null;
  @SerializedName("nux_data")
  private Object mNuxData = null;
  @SerializedName("nux_id")
  ...
  public UserNuxStatuses fetch() throws APIException{
    UserNuxStatuses newInstance = fetchById(this.getPrefixedId().toString(), this.context);
  ...
  public static APINodeList<UserNuxStatuses> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<UserNuxStatuses>)(
      new APIRequest<UserNuxStatuses>(context, "", "/", "GET", UserNuxStatuses.getParser())
  ...
  public static ListenableFuture<APINodeList<UserNuxStatuses>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", UserNuxStatuses.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static UserNuxStatuses loadJSON(String json, APIContext context) {
    UserNuxStatuses userNuxStatuses = getGson().fromJson(json, UserNuxStatuses.class);
    if (context.isDebug()) {
  ...
  public static APINodeList<UserNuxStatuses> parseResponse(String json, APIContext context, APIRequest request) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          userNuxStatusess.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            userNuxStatusess.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  userNuxStatusess.add(loadJSON(entry.getValue().toString(), context));
                }
                break;
              }
            }
            if (!isRedownload) {
              userNuxStatusess.add(loadJSON(obj.toString(), context));
            }
          }
          return userNuxStatusess;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              userNuxStatusess.add(loadJSON(value.toString(), context));
            } else {
          ...
          userNuxStatusess.add(loadJSON(json, context));
          return userNuxStatusess;
        }
      }
    } catch (Exception e) {
  ...
  public static class APIRequestGet extends APIRequest<UserNuxStatuses> {
    ...
    public UserNuxStatuses parseResponse(String response) throws APIException {
      return UserNuxStatuses.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<UserNuxStatuses> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<String, UserNuxStatuses>() {
  ...
  public static APIRequest.ResponseParser<UserNuxStatuses> getParser() {
    return new APIRequest.ResponseParser<UserNuxStatuses>() {
      public APINodeList<UserNuxStatuses> parseResponse(String response, APIContext context, APIRequest<UserNuxStatuses> request) throws MalformedResponseException {
