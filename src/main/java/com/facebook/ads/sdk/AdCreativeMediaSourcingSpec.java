...
public class AdCreativeMediaSourcingSpec extends APINode {
  ...
  private List<Long> mPushMetadataIds = null;
  ...
  public static AdCreativeMediaSourcingSpec loadJSON(String json, APIContext context, String header) {
    AdCreativeMediaSourcingSpec adCreativeMediaSourcingSpec = getGson().fromJson(json, AdCreativeMediaSourcingSpec.class);
    if (context.isDebug()) {
  ...
  public static APINodeList<AdCreativeMediaSourcingSpec> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adCreativeMediaSourcingSpecs.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adCreativeMediaSourcingSpecs.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adCreativeMediaSourcingSpecs.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              adCreativeMediaSourcingSpecs.add(loadJSON(obj.toString(), context, header));
            }
          }
          return adCreativeMediaSourcingSpecs;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adCreativeMediaSourcingSpecs.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          adCreativeMediaSourcingSpecs.add(loadJSON(json, context, header));
          return adCreativeMediaSourcingSpecs;
        }
      }
    } catch (Exception e) {
  ...
  public List<Long> getFieldPushMetadataIds() {
    return mPushMetadataIds;
  }

  public AdCreativeMediaSourcingSpec setFieldPushMetadataIds(List<Long> value) {
    this.mPushMetadataIds = value;
    return this;
  }
  ...
  public static APIRequest.ResponseParser<AdCreativeMediaSourcingSpec> getParser() {
    return new APIRequest.ResponseParser<AdCreativeMediaSourcingSpec>() {
      public APINodeList<AdCreativeMediaSourcingSpec> parseResponse(String response, APIContext context, APIRequest<AdCreativeMediaSourcingSpec> request, String header) throws MalformedResponseException {
