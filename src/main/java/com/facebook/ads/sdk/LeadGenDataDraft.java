...
public class LeadGenDataDraft extends APINode {
  ...
  @SerializedName("disqualified_end_component")
  private Object mDisqualifiedEndComponent = null;
  ...
  private List<Map<String, String>> mTrackingParameters = null;
  ...
  public static LeadGenDataDraft loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(leadGenDataDraft.toString());
  ...
  public Object getFieldDisqualifiedEndComponent() {
    return mDisqualifiedEndComponent;
  }
  ...
  public List<Map<String, String>> getFieldTrackingParameters() {
  ...
  public static class APIRequestGet extends APIRequest<LeadGenDataDraft> {
    ...
    public APIRequestGet requestDisqualifiedEndComponentField () {
      return this.requestDisqualifiedEndComponentField(true);
    }
    public APIRequestGet requestDisqualifiedEndComponentField (boolean value) {
      this.requestField("disqualified_end_component", value);
      return this;
    }
  ...
  public LeadGenDataDraft copyFrom(LeadGenDataDraft instance) {
    ...
    this.mDisqualifiedEndComponent = instance.mDisqualifiedEndComponent;
