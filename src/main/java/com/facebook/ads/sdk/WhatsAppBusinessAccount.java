...
public class WhatsAppBusinessAccount extends APINode {
  ...
  @SerializedName("marketing_messages_ad_account")
  private Object mMarketingMessagesAdAccount = null;
  ...
  @SerializedName("template_auto_archival_enabled")
  private Boolean mTemplateAutoArchivalEnabled = null;
  ...
  public Object getFieldMarketingMessagesAdAccount() {
    return mMarketingMessagesAdAccount;
  }
  ...
  public Boolean getFieldTemplateAutoArchivalEnabled() {
    return mTemplateAutoArchivalEnabled;
  }
  ...
  public static class APIRequestCreateBusinessMessagingFeatureStatus extends APIRequest<WhatsAppBusinessAccount> {
  ...
  public static class APIRequestDeleteMessageTemplates extends APIRequest<APINode> {
    ...
    public APIRequestDeleteMessageTemplates setHsmIds (List<String> hsmIds) {
      this.setParam("hsm_ids", hsmIds);
      return this;
    }
    public APIRequestDeleteMessageTemplates setHsmIds (String hsmIds) {
      this.setParam("hsm_ids", hsmIds);
      return this;
    }
  ...
  public static class APIRequestGetMessageTemplates extends APIRequest<APINode> {
    ...
    public APIRequestGetMessageTemplates setSince (String since) {
    ...
    public APIRequestGetMessageTemplates setUntil (String until) {
  ...
  public static class APIRequestCreateMessageTemplate extends APIRequest<WhatsAppBusinessAccount> {
    ...
    public APIRequestCreateMessageTemplate setIsPrimaryDeviceDeliveryOnly (Boolean isPrimaryDeviceDeliveryOnly) {
      this.setParam("is_primary_device_delivery_only", isPrimaryDeviceDeliveryOnly);
      return this;
    }
    public APIRequestCreateMessageTemplate setIsPrimaryDeviceDeliveryOnly (String isPrimaryDeviceDeliveryOnly) {
      this.setParam("is_primary_device_delivery_only", isPrimaryDeviceDeliveryOnly);
      return this;
    }
    ...
    public APIRequestCreateMessageTemplate setOptimizationSpec (Map<String, String> optimizationSpec) {
      this.setParam("optimization_spec", optimizationSpec);
      return this;
    }
    public APIRequestCreateMessageTemplate setOptimizationSpec (String optimizationSpec) {
      this.setParam("optimization_spec", optimizationSpec);
      return this;
    }
    ...
    public APIRequestCreateMessageTemplate setProductSetId (String productSetId) {
  ...
  public static class APIRequestGetTemplateAnalytics extends APIRequest<APINode> {
    ...
    public APIRequestGetTemplateAnalytics setMetricTypes (List<String> metricTypes) {
      this.setParam("metric_types", metricTypes);
      return this;
    }
  ...
  public static class APIRequestGetTemplateGroupAnalytics extends APIRequest<APINode> {
    ...
    public APIRequestGetTemplateGroupAnalytics setMetricTypes (List<String> metricTypes) {
      this.setParam("metric_types", metricTypes);
      return this;
    }
  ...
  public static class APIRequestGet extends APIRequest<WhatsAppBusinessAccount> {
    ...
    public APIRequestGet requestMarketingMessagesAdAccountField () {
      return this.requestMarketingMessagesAdAccountField(true);
    }
    public APIRequestGet requestMarketingMessagesAdAccountField (boolean value) {
    ...
    public APIRequestGet requestTemplateAutoArchivalEnabledField () {
      return this.requestTemplateAutoArchivalEnabledField(true);
    }
    public APIRequestGet requestTemplateAutoArchivalEnabledField (boolean value) {
  ...
  public static class APIRequestUpdate extends APIRequest<WhatsAppBusinessAccount> {
    ...
    public static final String[] PARAMS = {
      "creative_optimizations_enrollment",
      "degrees_of_freedom_spec",
      "disable_marketing_messages_on_cloud_api",
      "is_enabled_for_insights",
      "template_auto_archival_enabled",
    ...
    public APIRequestUpdate setCreativeOptimizationsEnrollment (Map<String, String> creativeOptimizationsEnrollment) {
      this.setParam("creative_optimizations_enrollment", creativeOptimizationsEnrollment);
      return this;
    }
    public APIRequestUpdate setCreativeOptimizationsEnrollment (String creativeOptimizationsEnrollment) {
      this.setParam("creative_optimizations_enrollment", creativeOptimizationsEnrollment);
      return this;
    }

    public APIRequestUpdate setDegreesOfFreedomSpec (Map<String, String> degreesOfFreedomSpec) {
      this.setParam("degrees_of_freedom_spec", degreesOfFreedomSpec);
      return this;
    }
    ...
    public APIRequestUpdate setTemplateAutoArchivalEnabled (Boolean templateAutoArchivalEnabled) {
      this.setParam("template_auto_archival_enabled", templateAutoArchivalEnabled);
      return this;
    }
    public APIRequestUpdate setTemplateAutoArchivalEnabled (String templateAutoArchivalEnabled) {
      this.setParam("template_auto_archival_enabled", templateAutoArchivalEnabled);
      return this;
    }
  ...
  public static enum EnumWhatsappBusinessManagerMessagingLimit {
      ...
      @SerializedName("TIER_50")
      VALUE_TIER_50("TIER_50"),
  ...
  public static enum EnumProductType {
      @SerializedName("CAMPAIGN_INSIGHTS")
      VALUE_CAMPAIGN_INSIGHTS("CAMPAIGN_INSIGHTS"),
  ...
  public WhatsAppBusinessAccount copyFrom(WhatsAppBusinessAccount instance) {
    ...
    this.mMarketingMessagesAdAccount = instance.mMarketingMessagesAdAccount;
