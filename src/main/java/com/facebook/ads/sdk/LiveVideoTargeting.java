...
public class LiveVideoTargeting extends APINode {
  ...
  public static LiveVideoTargeting loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(liveVideoTargeting.toString());
  ...
  public LiveVideoTargeting setFieldAgeMax(Long value) {
    this.mAgeMax = value;
    return this;
  }
  ...
  public LiveVideoTargeting setFieldAgeMin(Long value) {
    this.mAgeMin = value;
    return this;
  }
  ...
  public LiveVideoTargeting setFieldExcludedCountries(List<String> value) {
  ...
  public LiveVideoTargeting setFieldGeoLocations(TargetingGeoLocation value) {
    this.mGeoLocations = value;
    return this;
  }

  public LiveVideoTargeting setFieldGeoLocations(String value) {
