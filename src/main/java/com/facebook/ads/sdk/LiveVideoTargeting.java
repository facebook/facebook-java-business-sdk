 ...
 *
 */
public class LiveVideoTargeting extends APINode {
  ...
  public LiveVideoTargeting(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public LiveVideoTargeting(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public LiveVideoTargeting fetch() throws APIException{
    LiveVideoTargeting newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static LiveVideoTargeting fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<LiveVideoTargeting> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static LiveVideoTargeting fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<LiveVideoTargeting> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<LiveVideoTargeting> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<LiveVideoTargeting>)(
      new APIRequest<LiveVideoTargeting>(context, "", "/", "GET", LiveVideoTargeting.getParser())
  ...
  public static ListenableFuture<APINodeList<LiveVideoTargeting>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", LiveVideoTargeting.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static LiveVideoTargeting loadJSON(String json, APIContext context) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = parser.parse(liveVideoTargeting.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                liveVideoTargetings.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            liveVideoTargetings.setPaging(previous, next);
            if (context.hasAppSecret()) {
              liveVideoTargetings.setAppSecret(context.getAppSecretProof());
            }
          }
  ...
  public static class APIRequestGet extends APIRequest<LiveVideoTargeting> {

    LiveVideoTargeting lastResponse = null;
    @Override
    ...
    public LiveVideoTargeting parseResponse(String response) throws APIException {
      return LiveVideoTargeting.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<LiveVideoTargeting> executeAsync() throws APIException {
      return executeAsync(new HashMap<String, Object>());
    };

    public ListenableFuture<LiveVideoTargeting> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        executeAsyncInternal(extraParams),
        new Function<String, LiveVideoTargeting>() {
           public LiveVideoTargeting apply(String result) {
             try {
  ...
  public LiveVideoTargeting copyFrom(LiveVideoTargeting instance) {
