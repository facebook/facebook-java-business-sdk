 ...
 *
 */
public class DirectDealAvailableAdvertisers extends APINode {
  @SerializedName("id")
  ...
  public static DirectDealAvailableAdvertisers loadJSON(String json, APIContext context) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = parser.parse(directDealAvailableAdvertisers.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                directDealAvailableAdvertiserss.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            directDealAvailableAdvertiserss.setPaging(previous, next);
            if (context.hasAppSecret()) {
              directDealAvailableAdvertiserss.setAppSecret(context.getAppSecretProof());
            }
          }
  ...
  public DirectDealAvailableAdvertisers copyFrom(DirectDealAvailableAdvertisers instance) {
    this.mId = instance.mId;
    this.mLogo = instance.mLogo;
