...
public class CatalogItemAppealStatus extends APINode {
  ...
  public static enum EnumStatus {
      ...
      @SerializedName("Weve encountered unexpected error while processing this request. Please try again later !")
      VALUE_WEVE_ENCOUNTERED_UNEXPECTED_ERROR_WHILE_PROCESSING_THIS_REQUEST_PLEASE_TRY_AGAIN_LATER_("Weve encountered unexpected error while processing this request. Please try again later !"),
      @SerializedName("Youve reached the maximum number of item requests you can make this week. Youll be able to request item reviews again within the next 7 days.")
      VALUE_YOUVE_REACHED_THE_MAXIMUM_NUMBER_OF_ITEM_REQUESTS_YOU_CAN_MAKE_THIS_WEEK_YOULL_BE_ABLE_TO_REQUEST_ITEM_REVIEWS_AGAIN_WITHIN_THE_NEXT_7_DAYS_("Youve reached the maximum number of item requests you can make this week. Youll be able to request item reviews again within the next 7 days."),
