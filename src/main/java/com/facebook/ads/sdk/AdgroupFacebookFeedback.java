...
public class AdgroupFacebookFeedback extends APINode {
  ...
  public AdgroupFacebookFeedback() {
  }
  ...
  public static AdgroupFacebookFeedback loadJSON(String json, APIContext context, String header) {
    AdgroupFacebookFeedback adgroupFacebookFeedback = getGson().fromJson(json, AdgroupFacebookFeedback.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(adgroupFacebookFeedback.toString());
  ...
  public static APINodeList<AdgroupFacebookFeedback> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          adgroupFacebookFeedbacks.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            adgroupFacebookFeedbacks.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  adgroupFacebookFeedbacks.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              adgroupFacebookFeedbacks.add(loadJSON(obj.toString(), context, header));
            }
          }
          return adgroupFacebookFeedbacks;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              adgroupFacebookFeedbacks.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          adgroupFacebookFeedbacks.add(loadJSON(json, context, header));
          return adgroupFacebookFeedbacks;
        }
      }
    } catch (Exception e) {
  ...
  public APIRequestGetComments getComments() {
    return new APIRequestGetComments(this.getId(), context);
  }
  ...
  public static APIRequest.ResponseParser<AdgroupFacebookFeedback> getParser() {
    return new APIRequest.ResponseParser<AdgroupFacebookFeedback>() {
      public APINodeList<AdgroupFacebookFeedback> parseResponse(String response, APIContext context, APIRequest<AdgroupFacebookFeedback> request, String header) throws MalformedResponseException {
