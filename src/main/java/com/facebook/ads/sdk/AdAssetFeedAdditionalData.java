...
public class AdAssetFeedAdditionalData extends APINode {
  ...
  public static AdAssetFeedAdditionalData loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(adAssetFeedAdditionalData.toString());
  ...
  public static APINodeList<AdAssetFeedAdditionalData> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    APINodeList<AdAssetFeedAdditionalData> adAssetFeedAdditionalDatas = new APINodeList<AdAssetFeedAdditionalData>(request, json, header);
    JsonArray arr;
    JsonObject obj;
  ...
  public static APIRequest.ResponseParser<AdAssetFeedAdditionalData> getParser() {
    return new APIRequest.ResponseParser<AdAssetFeedAdditionalData>() {
      public APINodeList<AdAssetFeedAdditionalData> parseResponse(String response, APIContext context, APIRequest<AdAssetFeedAdditionalData> request, String header) throws MalformedResponseException {
