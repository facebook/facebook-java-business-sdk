...
public class AudienceInsightsRule extends APINode {
  ...
  private List<Object> mRuleComponents = null;
  ...
  public List<Object> getFieldRuleComponents() {
    return mRuleComponents;
  }
  ...
  public static class APIRequestGet extends APIRequest<AudienceInsightsRule> {
    ...
    public APIRequestGet requestRuleComponentsField () {
      return this.requestRuleComponentsField(true);
    }
    public APIRequestGet requestRuleComponentsField (boolean value) {
      this.requestField("rule_components", value);
      return this;
    }
  ...
  public AudienceInsightsRule copyFrom(AudienceInsightsRule instance) {
    ...
    this.mRuleComponents = instance.mRuleComponents;
