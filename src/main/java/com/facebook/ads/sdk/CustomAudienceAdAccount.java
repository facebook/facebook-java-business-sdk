 ...
 *
 */
public class CustomAudienceAdAccount extends APINode {
  @SerializedName("id")
  ...
  public CustomAudienceAdAccount(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public CustomAudienceAdAccount(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public CustomAudienceAdAccount fetch() throws APIException{
    CustomAudienceAdAccount newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static CustomAudienceAdAccount fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<CustomAudienceAdAccount> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static CustomAudienceAdAccount fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<CustomAudienceAdAccount> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<CustomAudienceAdAccount> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<CustomAudienceAdAccount>)(
      new APIRequest<CustomAudienceAdAccount>(context, "", "/", "GET", CustomAudienceAdAccount.getParser())
  ...
  public static ListenableFuture<APINodeList<CustomAudienceAdAccount>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", CustomAudienceAdAccount.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static CustomAudienceAdAccount loadJSON(String json, APIContext context) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = parser.parse(customAudienceAdAccount.toString());
  ...
  public static class APIRequestGet extends APIRequest<CustomAudienceAdAccount> {
    ...
    public ListenableFuture<CustomAudienceAdAccount> executeAsync() throws APIException {
      return executeAsync(new HashMap<String, Object>());
    };

    public ListenableFuture<CustomAudienceAdAccount> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        executeAsyncInternal(extraParams),
        new Function<String, CustomAudienceAdAccount>() {
           public CustomAudienceAdAccount apply(String result) {
             try {
  ...
  public CustomAudienceAdAccount copyFrom(CustomAudienceAdAccount instance) {
