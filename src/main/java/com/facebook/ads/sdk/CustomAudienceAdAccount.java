...
public class CustomAudienceAdAccount extends APINode {
  ...
  public CustomAudienceAdAccount() {
  }
  ...
  public static CustomAudienceAdAccount loadJSON(String json, APIContext context) {
    ...
    customAudienceAdAccount.mContext = context;
    customAudienceAdAccount.rawValue = json;
    return customAudienceAdAccount;
  }

  public static APINodeList<CustomAudienceAdAccount> parseResponse(String json, APIContext context, APIRequest request) {
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          try {
            ...
            customAudienceAdAccounts.setPaging(paging.get("before").getAsString(), paging.get("after").getAsString());
  ...
  public CustomAudienceAdAccount setFieldId(String value) {
    this.mId = value;
    return this;
  }
  ...
  public static APIRequest.ResponseParser<CustomAudienceAdAccount> getParser() {
    return new APIRequest.ResponseParser<CustomAudienceAdAccount>() {
      public APINodeList<CustomAudienceAdAccount> parseResponse(String response, APIContext context, APIRequest<CustomAudienceAdAccount> request) {
