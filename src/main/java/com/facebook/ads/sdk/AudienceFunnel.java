...
public class AudienceFunnel extends APINode {
  ...
  public static AudienceFunnel loadJSON(String json, APIContext context, String header) {
    AudienceFunnel audienceFunnel = getGson().fromJson(json, AudienceFunnel.class);
    if (context.isDebug()) {
      JsonElement o1 = JsonParser.parseString(json);
      JsonElement o2 = JsonParser.parseString(audienceFunnel.toString());
  ...
  public static APINodeList<AudienceFunnel> parseResponse(String json, APIContext context, APIRequest request, String header) throws MalformedResponseException {
    ...
    try{
      ...
      if (result.isJsonArray()) {
        ...
        for (int i = 0; i < arr.size(); i++) {
          audienceFunnels.add(loadJSON(arr.get(i).getAsJsonObject().toString(), context, header));
        };
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            audienceFunnels.setPaging(previous, next);
            ...
            for (String s : new String[]{"campaigns", "adsets", "ads"}) {
              if (obj.has(s)) {
                ...
                for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
                  audienceFunnels.add(loadJSON(entry.getValue().toString(), context, header));
                }
                break;
              }
            }
            if (!isRedownload) {
              audienceFunnels.add(loadJSON(obj.toString(), context, header));
            }
          }
          return audienceFunnels;
          ...
          for (Map.Entry entry : obj.entrySet()) {
            ...
            if (
              ...
              audienceFunnels.add(loadJSON(value.toString(), context, header));
            } else {
          ...
          audienceFunnels.add(loadJSON(json, context, header));
          return audienceFunnels;
        }
      }
    } catch (Exception e) {
  ...
  public List<Map<String, List<String>>> getFieldCustomAudienceGroupsInfo() {
    return mCustomAudienceGroupsInfo;
  }
  ...
  public static APIRequest.ResponseParser<AudienceFunnel> getParser() {
    return new APIRequest.ResponseParser<AudienceFunnel>() {
      public APINodeList<AudienceFunnel> parseResponse(String response, APIContext context, APIRequest<AudienceFunnel> request, String header) throws MalformedResponseException {
