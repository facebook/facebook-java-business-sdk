 ...
 *
 */
public class VideoCopyrightConditionGroup extends APINode {
  ...
  public static VideoCopyrightConditionGroup loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(videoCopyrightConditionGroup.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                videoCopyrightConditionGroups.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            videoCopyrightConditionGroups.setPaging(previous, next);
            if (context.hasAppSecret()) {
              videoCopyrightConditionGroups.setAppSecret(context.getAppSecretProof());
            }
          }
