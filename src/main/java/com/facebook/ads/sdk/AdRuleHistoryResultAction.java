...
public class AdRuleHistoryResultAction extends APINode {
  ...
  public static AdRuleHistoryResultAction loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(adRuleHistoryResultAction.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                adRuleHistoryResultActions.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            adRuleHistoryResultActions.setPaging(previous, next);
            if (context.hasAppSecret()) {
              adRuleHistoryResultActions.setAppSecret(context.getAppSecretProof());
            }
          }
  ...
  public AdRuleHistoryResultAction copyFrom(AdRuleHistoryResultAction instance) {
    ...
    this.mNewValue = instance.mNewValue;
    this.mOldValue = instance.mOldValue;
