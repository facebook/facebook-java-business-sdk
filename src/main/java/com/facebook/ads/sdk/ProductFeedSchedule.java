...
public class ProductFeedSchedule extends APINode {
  ...
  public static class APIRequestGet extends APIRequest<ProductFeedSchedule> {
    ...
    @Override
    public ProductFeedSchedule parseResponse(String response) throws APIException {
      return ProductFeedSchedule.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<ProductFeedSchedule> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        ...
        new Function<String, ProductFeedSchedule>() {
           public ProductFeedSchedule apply(String result) {
             try {
