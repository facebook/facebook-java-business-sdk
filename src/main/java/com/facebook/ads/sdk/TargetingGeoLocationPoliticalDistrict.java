...
public class TargetingGeoLocationPoliticalDistrict extends APINode {
  ...
  public static TargetingGeoLocationPoliticalDistrict loadJSON(String json, APIContext context, String header) {
    ...
    if (context.isDebug()) {
      ...
      JsonElement o2 = JsonParser.parseString(targetingGeoLocationPoliticalDistrict.toString());
        ...
        if (obj.has("data")) {
          if (obj.has("paging")) {
            ...
            if (paging.has("cursors")) {
                ...
                targetingGeoLocationPoliticalDistricts.setCursors(before, after);
            }
            String previous = paging.has("previous") ? paging.get("previous").getAsString() : null;
            String next = paging.has("next") ? paging.get("next").getAsString() : null;
            targetingGeoLocationPoliticalDistricts.setPaging(previous, next);
            if (context.hasAppSecret()) {
              targetingGeoLocationPoliticalDistricts.setAppSecret(context.getAppSecretProof());
            }
          }
