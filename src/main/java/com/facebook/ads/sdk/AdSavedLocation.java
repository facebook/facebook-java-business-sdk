...
public class AdSavedLocation extends APINode {
  ...
  public static class APIRequestUpdate extends APIRequest<AdSavedLocation> {
    ...
    public APIRequestUpdate setCities (List<Object> cities) {
      this.setParam("cities", cities);
      return this;
    }
    public APIRequestUpdate setCities (String cities) {
      this.setParam("cities", cities);
      return this;
    }

    public APIRequestUpdate setCountries (List<String> countries) {
    ...
    public APIRequestUpdate setCountryGroups (List<String> countryGroups) {
      this.setParam("country_groups", countryGroups);
      return this;
    }
    public APIRequestUpdate setCountryGroups (String countryGroups) {
      this.setParam("country_groups", countryGroups);
      return this;
    }

    public APIRequestUpdate setCustomLocations (List<Object> customLocations) {
      this.setParam("custom_locations", customLocations);
      return this;
    }
    public APIRequestUpdate setCustomLocations (String customLocations) {
      this.setParam("custom_locations", customLocations);
      return this;
    }

    public APIRequestUpdate setGeoMarkets (List<Object> geoMarkets) {
      this.setParam("geo_markets", geoMarkets);
      return this;
    }
    public APIRequestUpdate setGeoMarkets (String geoMarkets) {
      this.setParam("geo_markets", geoMarkets);
      return this;
    }
    ...
    public APIRequestUpdate setRegions (List<Object> regions) {
      this.setParam("regions", regions);
      return this;
    }
    public APIRequestUpdate setRegions (String regions) {
      this.setParam("regions", regions);
      return this;
    }

    public APIRequestUpdate setZips (List<Object> zips) {
      this.setParam("zips", zips);
      return this;
    }
    public APIRequestUpdate setZips (String zips) {
      this.setParam("zips", zips);
      return this;
    }
