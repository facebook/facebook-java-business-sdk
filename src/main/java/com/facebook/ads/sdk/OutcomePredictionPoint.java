...
public class OutcomePredictionPoint extends APINode {
  ...
  public OutcomePredictionPoint(Long id, APIContext context) {
    this(id.toString(), context);
  }

  public OutcomePredictionPoint(String id, APIContext context) {
    this.mId = id;

    this.context = context;
  }

  public OutcomePredictionPoint fetch() throws APIException{
    OutcomePredictionPoint newInstance = fetchById(this.getPrefixedId().toString(), this.context);
    this.copyFrom(newInstance);
    return this;
  }

  public static OutcomePredictionPoint fetchById(Long id, APIContext context) throws APIException {
    return fetchById(id.toString(), context);
  }

  public static ListenableFuture<OutcomePredictionPoint> fetchByIdAsync(Long id, APIContext context) throws APIException {
    return fetchByIdAsync(id.toString(), context);
  }

  public static OutcomePredictionPoint fetchById(String id, APIContext context) throws APIException {
    return
  ...
  public static ListenableFuture<OutcomePredictionPoint> fetchByIdAsync(String id, APIContext context) throws APIException {
    return
      new APIRequestGet(id, context)
      .requestAllFields()
      .executeAsync();
  ...
  public static APINodeList<OutcomePredictionPoint> fetchByIds(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return (APINodeList<OutcomePredictionPoint>)(
      new APIRequest<OutcomePredictionPoint>(context, "", "/", "GET", OutcomePredictionPoint.getParser())
  ...
  public static ListenableFuture<APINodeList<OutcomePredictionPoint>> fetchByIdsAsync(List<String> ids, List<String> fields, APIContext context) throws APIException {
    return
      new APIRequest(context, "", "/", "GET", OutcomePredictionPoint.getParser())
        .setParam("ids", APIRequest.joinStringList(ids))
        .requestFields(fields)
        .executeAsyncBase();
  }
  ...
  public static class APIRequestGet extends APIRequest<OutcomePredictionPoint> {

    OutcomePredictionPoint lastResponse = null;
    @Override
    ...
    public OutcomePredictionPoint parseResponse(String response) throws APIException {
      return OutcomePredictionPoint.parseResponse(response, getContext(), this).head();
    }
    ...
    public ListenableFuture<OutcomePredictionPoint> executeAsync() throws APIException {
      return executeAsync(new HashMap<String, Object>());
    };

    public ListenableFuture<OutcomePredictionPoint> executeAsync(Map<String, Object> extraParams) throws APIException {
      return Futures.transform(
        executeAsyncInternal(extraParams),
        new Function<String, OutcomePredictionPoint>() {
           public OutcomePredictionPoint apply(String result) {
             try {
