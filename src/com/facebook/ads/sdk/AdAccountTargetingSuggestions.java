...
public class AdAccountTargetingSuggestions extends APINode {
  @SerializedName("id")
  ...
  public AdAccountTargetingSuggestions() {
  }

  public String getId() {
    return getFieldId().toString();
  }
  public static AdAccountTargetingSuggestions loadJSON(String json, APIContext context) {
    AdAccountTargetingSuggestions adAccountTargetingSuggestions = getGson().fromJson(json, AdAccountTargetingSuggestions.class);
    if (context.isDebug()) {
      JsonParser parser = new JsonParser();
      JsonElement o1 = parser.parse(json);
      JsonElement o2 = parser.parse(adAccountTargetingSuggestions.toString());
    ...
    adAccountTargetingSuggestions.mContext = context;
    adAccountTargetingSuggestions.rawValue = json;
    return adAccountTargetingSuggestions;
  }
      ...
      if (result.isJsonArray()) {
        ...
        if (obj.has("data")) {
          try {
            ...
            adAccountTargetingSuggestionss.setPaging(paging.get("before").getAsString(), paging.get("after").getAsString());
  ...
  public AdAccountTargetingSuggestions setFieldId(String value) {
    this.mId = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions setFieldName(String value) {
    this.mName = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions setFieldType(EnumType value) {
    this.mType = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions setFieldPath(List<String> value) {
    this.mPath = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions setFieldDescription(String value) {
  ...
  public AdAccountTargetingSuggestions setFieldSource(String value) {
    this.mSource = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions setFieldPartner(String value) {
    this.mPartner = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions setFieldAudienceSize(Long value) {
  ...
  public AdAccountTargetingSuggestions setFieldCountry(String value) {
    this.mCountry = value;
    return this;
  }
  ...
  public AdAccountTargetingSuggestions copyFrom(AdAccountTargetingSuggestions instance) {
